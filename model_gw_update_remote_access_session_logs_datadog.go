...
// checks if the GwUpdateRemoteAccessSessionLogsDatadog type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GwUpdateRemoteAccessSessionLogsDatadog{}
...
func (o GwUpdateRemoteAccessSessionLogsDatadog) ToMap() (map[string]interface{}, error) {
