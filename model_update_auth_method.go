...
// UpdateAuthMethod updateAuthMethod is a command that updates a api key auth method. [Deprecated: Use auth-method-update-api-key command]
...
type _UpdateAuthMethod UpdateAuthMethod
...
func (o *UpdateAuthMethod) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateAuthMethod := _UpdateAuthMethod{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateAuthMethod)

	if err != nil {
		return err
	}

	*o = UpdateAuthMethod(varUpdateAuthMethod)
