...
func (o *DeleteRoles) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteRoles := _DeleteRoles{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteRoles)

	if err != nil {
		return err
	}

	*o = DeleteRoles(varDeleteRoles)
