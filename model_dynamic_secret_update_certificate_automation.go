...
// DynamicSecretUpdateCertificateAutomation dynamicSecretUpdateCertificateAutomation is a command that updates a Certificate Automation dynamic secret to dynamically update certificates generated by Venafi or have Akeyless generated certificates using PKI be monitored by Venafi
type DynamicSecretUpdateCertificateAutomation struct {
...
func NewDynamicSecretUpdateCertificateAutomation(name string, ) *DynamicSecretUpdateCertificateAutomation {
	this := DynamicSecretUpdateCertificateAutomation{}
...
func (o DynamicSecretUpdateCertificateAutomation) MarshalJSON() ([]byte, error) {
...
type NullableDynamicSecretUpdateCertificateAutomation struct {
	value *DynamicSecretUpdateCertificateAutomation
	isSet bool
}

func (v NullableDynamicSecretUpdateCertificateAutomation) Get() *DynamicSecretUpdateCertificateAutomation {
	return v.value
}

func (v *NullableDynamicSecretUpdateCertificateAutomation) Set(val *DynamicSecretUpdateCertificateAutomation) {
	v.value = val
	v.isSet = true
}

func (v NullableDynamicSecretUpdateCertificateAutomation) IsSet() bool {
	return v.isSet
}

func (v *NullableDynamicSecretUpdateCertificateAutomation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDynamicSecretUpdateCertificateAutomation(val *DynamicSecretUpdateCertificateAutomation) *NullableDynamicSecretUpdateCertificateAutomation {
	return &NullableDynamicSecretUpdateCertificateAutomation{value: val, isSet: true}
}

func (v NullableDynamicSecretUpdateCertificateAutomation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDynamicSecretUpdateCertificateAutomation) UnmarshalJSON(src []byte) error {
	v.isSet = true
