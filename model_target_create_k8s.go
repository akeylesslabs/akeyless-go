...
// checks if the TargetCreateK8s type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TargetCreateK8s{}
...
type _TargetCreateK8s TargetCreateK8s
...
func (o TargetCreateK8s) ToMap() (map[string]interface{}, error) {
...
func (o *TargetCreateK8s) UnmarshalJSON(data []byte) (err error) {
	...
	varTargetCreateK8s := _TargetCreateK8s{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTargetCreateK8s)

	if err != nil {
		return err
	}

	*o = TargetCreateK8s(varTargetCreateK8s)
