...
// DsCreateDockerhub dsCreateDockerhub is a command that creates a DOCKERHUB dynamic secret
type DsCreateDockerhub struct {
...
func (o DsCreateDockerhub) MarshalJSON() ([]byte, error) {
...
type NullableDsCreateDockerhub struct {
	value *DsCreateDockerhub
	isSet bool
}

func (v NullableDsCreateDockerhub) Get() *DsCreateDockerhub {
	return v.value
}

func (v *NullableDsCreateDockerhub) Set(val *DsCreateDockerhub) {
	v.value = val
	v.isSet = true
}

func (v NullableDsCreateDockerhub) IsSet() bool {
	return v.isSet
}

func (v *NullableDsCreateDockerhub) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDsCreateDockerhub(val *DsCreateDockerhub) *NullableDsCreateDockerhub {
	return &NullableDsCreateDockerhub{value: val, isSet: true}
}

func (v NullableDsCreateDockerhub) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDsCreateDockerhub) UnmarshalJSON(src []byte) error {
	v.isSet = true
