...
// checks if the CustomerFragment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomerFragment{}
...
func (o CustomerFragment) ToMap() (map[string]interface{}, error) {
