...
// checks if the DeleteTargetAssociation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteTargetAssociation{}
...
type _DeleteTargetAssociation DeleteTargetAssociation
...
func (o DeleteTargetAssociation) ToMap() (map[string]interface{}, error) {
...
func (o *DeleteTargetAssociation) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteTargetAssociation := _DeleteTargetAssociation{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteTargetAssociation)

	if err != nil {
		return err
	}

	*o = DeleteTargetAssociation(varDeleteTargetAssociation)
