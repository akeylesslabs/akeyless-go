...
// checks if the EventForwarderCreateTeams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EventForwarderCreateTeams{}

// EventForwarderCreateTeams eventForwarderCreateTeams is a command that creates teams event forwarder
type EventForwarderCreateTeams struct {
...
type _EventForwarderCreateTeams EventForwarderCreateTeams
...
func NewEventForwarderCreateTeams(gatewaysEventSourceLocations []string, name string, runnerType string, url string) *EventForwarderCreateTeams {
	this := EventForwarderCreateTeams{}
...
func (o EventForwarderCreateTeams) MarshalJSON() ([]byte, error) {
...
func (o EventForwarderCreateTeams) ToMap() (map[string]interface{}, error) {
...
func (o *EventForwarderCreateTeams) UnmarshalJSON(data []byte) (err error) {
	...
	varEventForwarderCreateTeams := _EventForwarderCreateTeams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEventForwarderCreateTeams)

	if err != nil {
		return err
	}

	*o = EventForwarderCreateTeams(varEventForwarderCreateTeams)

	return err
}

type NullableEventForwarderCreateTeams struct {
	value *EventForwarderCreateTeams
	isSet bool
}

func (v NullableEventForwarderCreateTeams) Get() *EventForwarderCreateTeams {
	return v.value
}

func (v *NullableEventForwarderCreateTeams) Set(val *EventForwarderCreateTeams) {
	v.value = val
	v.isSet = true
}

func (v NullableEventForwarderCreateTeams) IsSet() bool {
	return v.isSet
}

func (v *NullableEventForwarderCreateTeams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEventForwarderCreateTeams(val *EventForwarderCreateTeams) *NullableEventForwarderCreateTeams {
	return &NullableEventForwarderCreateTeams{value: val, isSet: true}
}

func (v NullableEventForwarderCreateTeams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEventForwarderCreateTeams) UnmarshalJSON(src []byte) error {
	v.isSet = true
