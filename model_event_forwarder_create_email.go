...
// checks if the EventForwarderCreateEmail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EventForwarderCreateEmail{}
...
type _EventForwarderCreateEmail EventForwarderCreateEmail
...
func (o EventForwarderCreateEmail) ToMap() (map[string]interface{}, error) {
...
func (o *EventForwarderCreateEmail) UnmarshalJSON(data []byte) (err error) {
	...
	varEventForwarderCreateEmail := _EventForwarderCreateEmail{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEventForwarderCreateEmail)

	if err != nil {
		return err
	}

	*o = EventForwarderCreateEmail(varEventForwarderCreateEmail)
