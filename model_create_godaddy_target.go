...
// checks if the CreateGodaddyTarget type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateGodaddyTarget{}
...
type _CreateGodaddyTarget CreateGodaddyTarget
...
func (o CreateGodaddyTarget) ToMap() (map[string]interface{}, error) {
...
func (o *CreateGodaddyTarget) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateGodaddyTarget := _CreateGodaddyTarget{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateGodaddyTarget)

	if err != nil {
		return err
	}

	*o = CreateGodaddyTarget(varCreateGodaddyTarget)
