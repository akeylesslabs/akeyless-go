...
// DsCreateRabbitMq dsCreateRabbitMq is a command that creates rabbitmq dynamic secret
type DsCreateRabbitMq struct {
...
func (o DsCreateRabbitMq) MarshalJSON() ([]byte, error) {
...
type NullableDsCreateRabbitMq struct {
	value *DsCreateRabbitMq
	isSet bool
}

func (v NullableDsCreateRabbitMq) Get() *DsCreateRabbitMq {
	return v.value
}

func (v *NullableDsCreateRabbitMq) Set(val *DsCreateRabbitMq) {
	v.value = val
	v.isSet = true
}

func (v NullableDsCreateRabbitMq) IsSet() bool {
	return v.isSet
}

func (v *NullableDsCreateRabbitMq) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDsCreateRabbitMq(val *DsCreateRabbitMq) *NullableDsCreateRabbitMq {
	return &NullableDsCreateRabbitMq{value: val, isSet: true}
}

func (v NullableDsCreateRabbitMq) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDsCreateRabbitMq) UnmarshalJSON(src []byte) error {
	v.isSet = true
