...
// checks if the GwUpdateRemoteAccessSessionLogsAwsS3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GwUpdateRemoteAccessSessionLogsAwsS3{}
...
type GwUpdateRemoteAccessSessionLogsAwsS3 struct {
...
func NewGwUpdateRemoteAccessSessionLogsAwsS3() *GwUpdateRemoteAccessSessionLogsAwsS3 {
	this := GwUpdateRemoteAccessSessionLogsAwsS3{}
...
func (o GwUpdateRemoteAccessSessionLogsAwsS3) MarshalJSON() ([]byte, error) {
...
func (o GwUpdateRemoteAccessSessionLogsAwsS3) ToMap() (map[string]interface{}, error) {
...
type NullableGwUpdateRemoteAccessSessionLogsAwsS3 struct {
	value *GwUpdateRemoteAccessSessionLogsAwsS3
	isSet bool
}

func (v NullableGwUpdateRemoteAccessSessionLogsAwsS3) Get() *GwUpdateRemoteAccessSessionLogsAwsS3 {
	return v.value
}

func (v *NullableGwUpdateRemoteAccessSessionLogsAwsS3) Set(val *GwUpdateRemoteAccessSessionLogsAwsS3) {
	v.value = val
	v.isSet = true
}

func (v NullableGwUpdateRemoteAccessSessionLogsAwsS3) IsSet() bool {
	return v.isSet
}

func (v *NullableGwUpdateRemoteAccessSessionLogsAwsS3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGwUpdateRemoteAccessSessionLogsAwsS3(val *GwUpdateRemoteAccessSessionLogsAwsS3) *NullableGwUpdateRemoteAccessSessionLogsAwsS3 {
	return &NullableGwUpdateRemoteAccessSessionLogsAwsS3{value: val, isSet: true}
}

func (v NullableGwUpdateRemoteAccessSessionLogsAwsS3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGwUpdateRemoteAccessSessionLogsAwsS3) UnmarshalJSON(src []byte) error {
	v.isSet = true
