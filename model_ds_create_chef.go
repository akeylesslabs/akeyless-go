...
// DsCreateChef dsCreateChef is a command that creates chef dynamic secret
type DsCreateChef struct {
	// Organizations
...
func (o DsCreateChef) MarshalJSON() ([]byte, error) {
...
type NullableDsCreateChef struct {
	value *DsCreateChef
	isSet bool
}

func (v NullableDsCreateChef) Get() *DsCreateChef {
	return v.value
}

func (v *NullableDsCreateChef) Set(val *DsCreateChef) {
	v.value = val
	v.isSet = true
}

func (v NullableDsCreateChef) IsSet() bool {
	return v.isSet
}

func (v *NullableDsCreateChef) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDsCreateChef(val *DsCreateChef) *NullableDsCreateChef {
	return &NullableDsCreateChef{value: val, isSet: true}
}

func (v NullableDsCreateChef) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDsCreateChef) UnmarshalJSON(src []byte) error {
	v.isSet = true
