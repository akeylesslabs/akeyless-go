...
// checks if the CreateAuthMethodEmail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAuthMethodEmail{}
...
type _CreateAuthMethodEmail CreateAuthMethodEmail
...
func (o CreateAuthMethodEmail) ToMap() (map[string]interface{}, error) {
...
func (o *CreateAuthMethodEmail) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateAuthMethodEmail := _CreateAuthMethodEmail{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateAuthMethodEmail)

	if err != nil {
		return err
	}

	*o = CreateAuthMethodEmail(varCreateAuthMethodEmail)
