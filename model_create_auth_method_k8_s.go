...
// checks if the CreateAuthMethodK8S type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAuthMethodK8S{}
...
type _CreateAuthMethodK8S CreateAuthMethodK8S
...
func (o CreateAuthMethodK8S) ToMap() (map[string]interface{}, error) {
...
func (o *CreateAuthMethodK8S) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateAuthMethodK8S := _CreateAuthMethodK8S{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateAuthMethodK8S)

	if err != nil {
		return err
	}

	*o = CreateAuthMethodK8S(varCreateAuthMethodK8S)
