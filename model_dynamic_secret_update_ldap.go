...
// checks if the DynamicSecretUpdateLdap type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DynamicSecretUpdateLdap{}
...
type _DynamicSecretUpdateLdap DynamicSecretUpdateLdap
...
func (o DynamicSecretUpdateLdap) ToMap() (map[string]interface{}, error) {
...
func (o *DynamicSecretUpdateLdap) UnmarshalJSON(data []byte) (err error) {
	...
	varDynamicSecretUpdateLdap := _DynamicSecretUpdateLdap{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDynamicSecretUpdateLdap)

	if err != nil {
		return err
	}

	*o = DynamicSecretUpdateLdap(varDynamicSecretUpdateLdap)
