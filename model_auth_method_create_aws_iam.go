...
// checks if the AuthMethodCreateAwsIam type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthMethodCreateAwsIam{}

// AuthMethodCreateAwsIam authMethodCreateAwsIam is a command that creates a new Auth Method that will be able to authenticate using AWS IAM credentials.
type AuthMethodCreateAwsIam struct {
...
type _AuthMethodCreateAwsIam AuthMethodCreateAwsIam
...
func (o AuthMethodCreateAwsIam) MarshalJSON() ([]byte, error) {
...
func (o AuthMethodCreateAwsIam) ToMap() (map[string]interface{}, error) {
...
func (o *AuthMethodCreateAwsIam) UnmarshalJSON(data []byte) (err error) {
	...
	varAuthMethodCreateAwsIam := _AuthMethodCreateAwsIam{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAuthMethodCreateAwsIam)

	if err != nil {
		return err
	}

	*o = AuthMethodCreateAwsIam(varAuthMethodCreateAwsIam)

	return err
}

type NullableAuthMethodCreateAwsIam struct {
	value *AuthMethodCreateAwsIam
	isSet bool
}

func (v NullableAuthMethodCreateAwsIam) Get() *AuthMethodCreateAwsIam {
	return v.value
}

func (v *NullableAuthMethodCreateAwsIam) Set(val *AuthMethodCreateAwsIam) {
	v.value = val
	v.isSet = true
}

func (v NullableAuthMethodCreateAwsIam) IsSet() bool {
	return v.isSet
}

func (v *NullableAuthMethodCreateAwsIam) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuthMethodCreateAwsIam(val *AuthMethodCreateAwsIam) *NullableAuthMethodCreateAwsIam {
	return &NullableAuthMethodCreateAwsIam{value: val, isSet: true}
}

func (v NullableAuthMethodCreateAwsIam) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuthMethodCreateAwsIam) UnmarshalJSON(src []byte) error {
	v.isSet = true
