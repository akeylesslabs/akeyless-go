...
// checks if the CreateGitlabTarget type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateGitlabTarget{}
...
type _CreateGitlabTarget CreateGitlabTarget
...
func (o CreateGitlabTarget) ToMap() (map[string]interface{}, error) {
...
func (o *CreateGitlabTarget) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateGitlabTarget := _CreateGitlabTarget{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateGitlabTarget)

	if err != nil {
		return err
	}

	*o = CreateGitlabTarget(varCreateGitlabTarget)
