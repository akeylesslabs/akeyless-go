...
// checks if the AuthMethodCreateOCI type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthMethodCreateOCI{}
...
type AuthMethodCreateOCI struct {
...
type _AuthMethodCreateOCI AuthMethodCreateOCI
...
func (o AuthMethodCreateOCI) MarshalJSON() ([]byte, error) {
...
func (o AuthMethodCreateOCI) ToMap() (map[string]interface{}, error) {
...
func (o *AuthMethodCreateOCI) UnmarshalJSON(data []byte) (err error) {
	...
	varAuthMethodCreateOCI := _AuthMethodCreateOCI{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAuthMethodCreateOCI)

	if err != nil {
		return err
	}

	*o = AuthMethodCreateOCI(varAuthMethodCreateOCI)

	return err
}

type NullableAuthMethodCreateOCI struct {
	value *AuthMethodCreateOCI
	isSet bool
}

func (v NullableAuthMethodCreateOCI) Get() *AuthMethodCreateOCI {
	return v.value
}

func (v *NullableAuthMethodCreateOCI) Set(val *AuthMethodCreateOCI) {
	v.value = val
	v.isSet = true
}

func (v NullableAuthMethodCreateOCI) IsSet() bool {
	return v.isSet
}

func (v *NullableAuthMethodCreateOCI) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuthMethodCreateOCI(val *AuthMethodCreateOCI) *NullableAuthMethodCreateOCI {
	return &NullableAuthMethodCreateOCI{value: val, isSet: true}
}

func (v NullableAuthMethodCreateOCI) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuthMethodCreateOCI) UnmarshalJSON(src []byte) error {
	v.isSet = true
