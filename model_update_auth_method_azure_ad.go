...
// checks if the UpdateAuthMethodAzureAD type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateAuthMethodAzureAD{}

// UpdateAuthMethodAzureAD updateAuthMethodAzureAD is a command that updates a new auth method that will be able to authenticate using Azure Active Directory credentials. [Deprecated: Use auth-method-update-azure-ad command]
...
type _UpdateAuthMethodAzureAD UpdateAuthMethodAzureAD
...
func (o UpdateAuthMethodAzureAD) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateAuthMethodAzureAD) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateAuthMethodAzureAD := _UpdateAuthMethodAzureAD{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateAuthMethodAzureAD)

	if err != nil {
		return err
	}

	*o = UpdateAuthMethodAzureAD(varUpdateAuthMethodAzureAD)
