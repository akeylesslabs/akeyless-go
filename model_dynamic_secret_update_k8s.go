...
// checks if the DynamicSecretUpdateK8s type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DynamicSecretUpdateK8s{}
...
type _DynamicSecretUpdateK8s DynamicSecretUpdateK8s
...
func (o DynamicSecretUpdateK8s) ToMap() (map[string]interface{}, error) {
...
func (o *DynamicSecretUpdateK8s) UnmarshalJSON(data []byte) (err error) {
	...
	varDynamicSecretUpdateK8s := _DynamicSecretUpdateK8s{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDynamicSecretUpdateK8s)

	if err != nil {
		return err
	}

	*o = DynamicSecretUpdateK8s(varDynamicSecretUpdateK8s)
