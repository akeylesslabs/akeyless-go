...
// DsUpdateMongoDb dsUpdateMongoDb is a command that updates either mongodb  dynamic secret or mongodb atlas dynamic secret
type DsUpdateMongoDb struct {
...
func (o DsUpdateMongoDb) MarshalJSON() ([]byte, error) {
...
type NullableDsUpdateMongoDb struct {
	value *DsUpdateMongoDb
	isSet bool
}

func (v NullableDsUpdateMongoDb) Get() *DsUpdateMongoDb {
	return v.value
}

func (v *NullableDsUpdateMongoDb) Set(val *DsUpdateMongoDb) {
	v.value = val
	v.isSet = true
}

func (v NullableDsUpdateMongoDb) IsSet() bool {
	return v.isSet
}

func (v *NullableDsUpdateMongoDb) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDsUpdateMongoDb(val *DsUpdateMongoDb) *NullableDsUpdateMongoDb {
	return &NullableDsUpdateMongoDb{value: val, isSet: true}
}

func (v NullableDsUpdateMongoDb) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDsUpdateMongoDb) UnmarshalJSON(src []byte) error {
	v.isSet = true
