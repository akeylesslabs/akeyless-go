...
type DSProducerDetails struct {
	...
	CreateCertUsingPki *bool `json:"create_cert_using_pki,omitempty"`
...
func (o *DSProducerDetails) GetAllowSubdomains() bool {
...
// and a boolean to check if the value has been set.
func (o *DSProducerDetails) GetAllowSubdomainsOk() (*bool, bool) {
	if o == nil || o.AllowSubdomains == nil {
		return nil, false
	}
...
func (o *DSProducerDetails) HasAllowSubdomains() bool {
	if o != nil && o.AllowSubdomains != nil {
		return true
	}
...
func (o *DSProducerDetails) SetAllowSubdomains(v bool) {
	o.AllowSubdomains = &v
}

// GetAllowedDomains returns the AllowedDomains field value if set, zero value otherwise.
func (o *DSProducerDetails) GetAllowedDomains() string {
...
// and a boolean to check if the value has been set.
func (o *DSProducerDetails) GetAllowedDomainsOk() (*string, bool) {
	if o == nil || o.AllowedDomains == nil {
		return nil, false
	}
...
func (o *DSProducerDetails) HasAllowedDomains() bool {
	if o != nil && o.AllowedDomains != nil {
		return true
	}
...
func (o *DSProducerDetails) SetAllowedDomains(v string) {
	o.AllowedDomains = &v
}
...
func (o *DSProducerDetails) GetAutoGeneratedFolder() string {
...
// and a boolean to check if the value has been set.
func (o *DSProducerDetails) GetAutoGeneratedFolderOk() (*string, bool) {
	if o == nil || o.AutoGeneratedFolder == nil {
		return nil, false
	}
...
func (o *DSProducerDetails) HasAutoGeneratedFolder() bool {
	if o != nil && o.AutoGeneratedFolder != nil {
		return true
	}
...
func (o *DSProducerDetails) SetAutoGeneratedFolder(v string) {
...
// GetCreateCertUsingPki returns the CreateCertUsingPki field value if set, zero value otherwise.
func (o *DSProducerDetails) GetCreateCertUsingPki() bool {
	if o == nil || o.CreateCertUsingPki == nil {
		var ret bool
		return ret
	}
	return *o.CreateCertUsingPki
}

// GetCreateCertUsingPkiOk returns a tuple with the CreateCertUsingPki field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DSProducerDetails) GetCreateCertUsingPkiOk() (*bool, bool) {
	if o == nil || o.CreateCertUsingPki == nil {
		return nil, false
	}
	return o.CreateCertUsingPki, true
}

// HasCreateCertUsingPki returns a boolean if a field has been set.
func (o *DSProducerDetails) HasCreateCertUsingPki() bool {
	if o != nil && o.CreateCertUsingPki != nil {
		return true
	}
...
// SetCreateCertUsingPki gets a reference to the given bool and assigns it to the CreateCertUsingPki field.
func (o *DSProducerDetails) SetCreateCertUsingPki(v bool) {
	o.CreateCertUsingPki = &v
}
...
func (o *DSProducerDetails) GetRootFirstInChain() bool {
...
// and a boolean to check if the value has been set.
func (o *DSProducerDetails) GetRootFirstInChainOk() (*bool, bool) {
	if o == nil || o.RootFirstInChain == nil {
		return nil, false
	}
...
func (o *DSProducerDetails) HasRootFirstInChain() bool {
	if o != nil && o.RootFirstInChain != nil {
		return true
	}
...
func (o *DSProducerDetails) SetRootFirstInChain(v bool) {
...
func (o *DSProducerDetails) GetSignerKeyName() string {
...
// and a boolean to check if the value has been set.
func (o *DSProducerDetails) GetSignerKeyNameOk() (*string, bool) {
	if o == nil || o.SignerKeyName == nil {
		return nil, false
	}
...
func (o *DSProducerDetails) HasSignerKeyName() bool {
	if o != nil && o.SignerKeyName != nil {
		return true
	}
...
func (o *DSProducerDetails) SetSignerKeyName(v string) {
	o.SignerKeyName = &v
}

// GetStorePrivateKey returns the StorePrivateKey field value if set, zero value otherwise.
func (o *DSProducerDetails) GetStorePrivateKey() bool {
...
// and a boolean to check if the value has been set.
func (o *DSProducerDetails) GetStorePrivateKeyOk() (*bool, bool) {
	if o == nil || o.StorePrivateKey == nil {
		return nil, false
	}
...
func (o *DSProducerDetails) HasStorePrivateKey() bool {
	if o != nil && o.StorePrivateKey != nil {
		return true
	}
...
func (o *DSProducerDetails) SetStorePrivateKey(v bool) {
	o.StorePrivateKey = &v
}
...
func (o DSProducerDetails) MarshalJSON() ([]byte, error) {
	...
	if o.AutoGeneratedFolder != nil {
		toSerialize["auto_generated_folder"] = o.AutoGeneratedFolder
	}
	...
	if o.CreateCertUsingPki != nil {
		toSerialize["create_cert_using_pki"] = o.CreateCertUsingPki
	}
	if o.DbHostName != nil {
	...
	if o.RootFirstInChain != nil {
		toSerialize["root_first_in_chain"] = o.RootFirstInChain
	}
	if o.ShouldStop != nil {
		toSerialize["should_stop"] = o.ShouldStop
	}
	if o.SignerKeyName != nil {
		toSerialize["signer_key_name"] = o.SignerKeyName
	}
	if o.StorePrivateKey != nil {
		toSerialize["store_private_key"] = o.StorePrivateKey
	}
