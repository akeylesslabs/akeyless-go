...
// DsUpdateOracleDb dsUpdateOracleDb is a command that updates oracle db dynamic secret
type DsUpdateOracleDb struct {
...
func (o DsUpdateOracleDb) MarshalJSON() ([]byte, error) {
...
type NullableDsUpdateOracleDb struct {
	value *DsUpdateOracleDb
	isSet bool
}

func (v NullableDsUpdateOracleDb) Get() *DsUpdateOracleDb {
	return v.value
}

func (v *NullableDsUpdateOracleDb) Set(val *DsUpdateOracleDb) {
	v.value = val
	v.isSet = true
}

func (v NullableDsUpdateOracleDb) IsSet() bool {
	return v.isSet
}

func (v *NullableDsUpdateOracleDb) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDsUpdateOracleDb(val *DsUpdateOracleDb) *NullableDsUpdateOracleDb {
	return &NullableDsUpdateOracleDb{value: val, isSet: true}
}

func (v NullableDsUpdateOracleDb) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDsUpdateOracleDb) UnmarshalJSON(src []byte) error {
	v.isSet = true
