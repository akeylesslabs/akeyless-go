...
// checks if the GatewayDeleteProducerOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GatewayDeleteProducerOutput{}
...
func (o GatewayDeleteProducerOutput) ToMap() (map[string]interface{}, error) {
