...
// checks if the GatewayCreateProducerEks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GatewayCreateProducerEks{}
...
type _GatewayCreateProducerEks GatewayCreateProducerEks
...
func (o GatewayCreateProducerEks) ToMap() (map[string]interface{}, error) {
...
func (o *GatewayCreateProducerEks) UnmarshalJSON(data []byte) (err error) {
	...
	varGatewayCreateProducerEks := _GatewayCreateProducerEks{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGatewayCreateProducerEks)

	if err != nil {
		return err
	}

	*o = GatewayCreateProducerEks(varGatewayCreateProducerEks)
