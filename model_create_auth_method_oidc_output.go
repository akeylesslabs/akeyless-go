...
// checks if the CreateAuthMethodOIDCOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAuthMethodOIDCOutput{}
...
func (o CreateAuthMethodOIDCOutput) ToMap() (map[string]interface{}, error) {
