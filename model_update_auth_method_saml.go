...
type _UpdateAuthMethodSAML UpdateAuthMethodSAML
...
func (o *UpdateAuthMethodSAML) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateAuthMethodSAML := _UpdateAuthMethodSAML{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateAuthMethodSAML)

	if err != nil {
		return err
	}

	*o = UpdateAuthMethodSAML(varUpdateAuthMethodSAML)
