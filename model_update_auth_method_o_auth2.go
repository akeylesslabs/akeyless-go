...
// checks if the UpdateAuthMethodOAuth2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateAuthMethodOAuth2{}
...
type _UpdateAuthMethodOAuth2 UpdateAuthMethodOAuth2
...
func (o UpdateAuthMethodOAuth2) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateAuthMethodOAuth2) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateAuthMethodOAuth2 := _UpdateAuthMethodOAuth2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateAuthMethodOAuth2)

	if err != nil {
		return err
	}

	*o = UpdateAuthMethodOAuth2(varUpdateAuthMethodOAuth2)
