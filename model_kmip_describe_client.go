...
// checks if the KmipDescribeClient type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KmipDescribeClient{}
...
func (o KmipDescribeClient) ToMap() (map[string]interface{}, error) {
