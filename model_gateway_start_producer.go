...
// checks if the GatewayStartProducer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GatewayStartProducer{}
...
type _GatewayStartProducer GatewayStartProducer
...
func (o GatewayStartProducer) ToMap() (map[string]interface{}, error) {
...
func (o *GatewayStartProducer) UnmarshalJSON(data []byte) (err error) {
	...
	varGatewayStartProducer := _GatewayStartProducer{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGatewayStartProducer)

	if err != nil {
		return err
	}

	*o = GatewayStartProducer(varGatewayStartProducer)
