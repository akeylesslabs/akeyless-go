...
// DsCreateRedis dsCreateRedis is a command that creates Redis dynamic secret
type DsCreateRedis struct {
...
func (o DsCreateRedis) MarshalJSON() ([]byte, error) {
...
type NullableDsCreateRedis struct {
	value *DsCreateRedis
	isSet bool
}

func (v NullableDsCreateRedis) Get() *DsCreateRedis {
	return v.value
}

func (v *NullableDsCreateRedis) Set(val *DsCreateRedis) {
	v.value = val
	v.isSet = true
}

func (v NullableDsCreateRedis) IsSet() bool {
	return v.isSet
}

func (v *NullableDsCreateRedis) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDsCreateRedis(val *DsCreateRedis) *NullableDsCreateRedis {
	return &NullableDsCreateRedis{value: val, isSet: true}
}

func (v NullableDsCreateRedis) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDsCreateRedis) UnmarshalJSON(src []byte) error {
	v.isSet = true
