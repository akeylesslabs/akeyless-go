...
// checks if the UpdateGcpTarget type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateGcpTarget{}
...
type _UpdateGcpTarget UpdateGcpTarget
...
func (o UpdateGcpTarget) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateGcpTarget) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateGcpTarget := _UpdateGcpTarget{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateGcpTarget)

	if err != nil {
		return err
	}

	*o = UpdateGcpTarget(varUpdateGcpTarget)
