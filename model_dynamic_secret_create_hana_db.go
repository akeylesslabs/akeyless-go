...
// checks if the DynamicSecretCreateHanaDb type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DynamicSecretCreateHanaDb{}
...
type _DynamicSecretCreateHanaDb DynamicSecretCreateHanaDb
...
func (o DynamicSecretCreateHanaDb) ToMap() (map[string]interface{}, error) {
...
func (o *DynamicSecretCreateHanaDb) UnmarshalJSON(data []byte) (err error) {
	...
	varDynamicSecretCreateHanaDb := _DynamicSecretCreateHanaDb{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDynamicSecretCreateHanaDb)

	if err != nil {
		return err
	}

	*o = DynamicSecretCreateHanaDb(varDynamicSecretCreateHanaDb)
