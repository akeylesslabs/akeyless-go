...
// checks if the CreateAuthMethodUniversalIdentity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAuthMethodUniversalIdentity{}
...
type _CreateAuthMethodUniversalIdentity CreateAuthMethodUniversalIdentity
...
func (o CreateAuthMethodUniversalIdentity) ToMap() (map[string]interface{}, error) {
...
func (o *CreateAuthMethodUniversalIdentity) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateAuthMethodUniversalIdentity := _CreateAuthMethodUniversalIdentity{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateAuthMethodUniversalIdentity)

	if err != nil {
		return err
	}

	*o = CreateAuthMethodUniversalIdentity(varCreateAuthMethodUniversalIdentity)
