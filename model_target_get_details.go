...
// checks if the TargetGetDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TargetGetDetails{}
...
type _TargetGetDetails TargetGetDetails
...
func (o TargetGetDetails) ToMap() (map[string]interface{}, error) {
...
func (o *TargetGetDetails) UnmarshalJSON(data []byte) (err error) {
	...
	varTargetGetDetails := _TargetGetDetails{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTargetGetDetails)

	if err != nil {
		return err
	}

	*o = TargetGetDetails(varTargetGetDetails)
