...
// checks if the TargetCreateDB type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TargetCreateDB{}

// TargetCreateDB struct for TargetCreateDB
type TargetCreateDB struct {
...
type _TargetCreateDB TargetCreateDB
...
func (o TargetCreateDB) MarshalJSON() ([]byte, error) {
...
func (o TargetCreateDB) ToMap() (map[string]interface{}, error) {
...
func (o *TargetCreateDB) UnmarshalJSON(data []byte) (err error) {
	...
	varTargetCreateDB := _TargetCreateDB{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTargetCreateDB)

	if err != nil {
		return err
	}

	*o = TargetCreateDB(varTargetCreateDB)

	return err
}

type NullableTargetCreateDB struct {
	value *TargetCreateDB
	isSet bool
}

func (v NullableTargetCreateDB) Get() *TargetCreateDB {
	return v.value
}

func (v *NullableTargetCreateDB) Set(val *TargetCreateDB) {
	v.value = val
	v.isSet = true
}

func (v NullableTargetCreateDB) IsSet() bool {
	return v.isSet
}

func (v *NullableTargetCreateDB) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTargetCreateDB(val *TargetCreateDB) *NullableTargetCreateDB {
	return &NullableTargetCreateDB{value: val, isSet: true}
}

func (v NullableTargetCreateDB) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTargetCreateDB) UnmarshalJSON(src []byte) error {
	v.isSet = true
