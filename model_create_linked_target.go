...
// checks if the CreateLinkedTarget type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateLinkedTarget{}
...
type _CreateLinkedTarget CreateLinkedTarget
...
func (o CreateLinkedTarget) ToMap() (map[string]interface{}, error) {
...
func (o *CreateLinkedTarget) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateLinkedTarget := _CreateLinkedTarget{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateLinkedTarget)

	if err != nil {
		return err
	}

	*o = CreateLinkedTarget(varCreateLinkedTarget)
