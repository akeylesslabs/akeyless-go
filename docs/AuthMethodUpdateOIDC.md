...
`func (o *AuthMethodUpdateOIDC) GetGatewayUrl() string`

GetGatewayUrl returns the GatewayUrl field if non-nil, zero value otherwise.

### GetGatewayUrlOk

`func (o *AuthMethodUpdateOIDC) GetGatewayUrlOk() (*string, bool)`
...
`func (o *AuthMethodUpdateOIDC) SetGatewayUrl(v string)`

SetGatewayUrl sets GatewayUrl field to given value.

### HasGatewayUrl

`func (o *AuthMethodUpdateOIDC) HasGatewayUrl() bool`
