...
`func (o *CreateArtifactoryTarget) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *CreateArtifactoryTarget) GetLockOnReadOk() (*string, bool)`
...
`func (o *CreateArtifactoryTarget) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *CreateArtifactoryTarget) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *CreateArtifactoryTarget) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *CreateArtifactoryTarget) GetLockTtlOk() (*string, bool)`
...
`func (o *CreateArtifactoryTarget) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *CreateArtifactoryTarget) HasLockTtl() bool`
...
`func (o *CreateArtifactoryTarget) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *CreateArtifactoryTarget) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *CreateArtifactoryTarget) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *CreateArtifactoryTarget) HasRotateOnUnlock() bool`
