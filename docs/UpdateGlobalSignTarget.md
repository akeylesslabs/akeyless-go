...
`func (o *UpdateGlobalSignTarget) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *UpdateGlobalSignTarget) GetLockOnReadOk() (*string, bool)`
...
`func (o *UpdateGlobalSignTarget) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *UpdateGlobalSignTarget) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *UpdateGlobalSignTarget) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *UpdateGlobalSignTarget) GetLockTtlOk() (*string, bool)`
...
`func (o *UpdateGlobalSignTarget) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *UpdateGlobalSignTarget) HasLockTtl() bool`
...
`func (o *UpdateGlobalSignTarget) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *UpdateGlobalSignTarget) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *UpdateGlobalSignTarget) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *UpdateGlobalSignTarget) HasRotateOnUnlock() bool`
