...
`func (o *CreateDBTarget) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *CreateDBTarget) GetLockOnReadOk() (*string, bool)`
...
`func (o *CreateDBTarget) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *CreateDBTarget) HasLockTtl() bool`
...
`func (o *CreateDBTarget) GetOracleWalletLoginType() string`
...
`func (o *CreateDBTarget) GetOracleWalletLoginTypeOk() (*string, bool)`
...
`func (o *CreateDBTarget) GetOracleWalletP12FileDataOk() (*string, bool)`
...
`func (o *CreateDBTarget) GetOracleWalletSsoFileDataOk() (*string, bool)`
...
`func (o *CreateDBTarget) SetParentTargetName(v string)`

SetParentTargetName sets ParentTargetName field to given value.

### HasParentTargetName

`func (o *CreateDBTarget) HasParentTargetName() bool`
...
`func (o *CreateDBTarget) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *CreateDBTarget) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *CreateDBTarget) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *CreateDBTarget) HasRotateOnUnlock() bool`
