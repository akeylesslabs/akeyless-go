...
`func (o *CreateAuthMethodUniversalIdentity) GetChildTtlLimit() int32`

GetChildTtlLimit returns the ChildTtlLimit field if non-nil, zero value otherwise.

### GetChildTtlLimitOk

`func (o *CreateAuthMethodUniversalIdentity) GetChildTtlLimitOk() (*int32, bool)`
...
`func (o *CreateAuthMethodUniversalIdentity) SetChildTtlLimit(v int32)`

SetChildTtlLimit sets ChildTtlLimit field to given value.

### HasChildTtlLimit

`func (o *CreateAuthMethodUniversalIdentity) HasChildTtlLimit() bool`
...
`func (o *CreateAuthMethodUniversalIdentity) GetTreeLength() int32`

GetTreeLength returns the TreeLength field if non-nil, zero value otherwise.

### GetTreeLengthOk

`func (o *CreateAuthMethodUniversalIdentity) GetTreeLengthOk() (*int32, bool)`
...
`func (o *CreateAuthMethodUniversalIdentity) SetTreeLength(v int32)`

SetTreeLength sets TreeLength field to given value.

### HasTreeLength

`func (o *CreateAuthMethodUniversalIdentity) HasTreeLength() bool`
