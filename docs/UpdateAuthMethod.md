...
`func (o *UpdateAuthMethod) SetAuditLogsClaims(v []string)`

SetAuditLogsClaims sets AuditLogsClaims field to given value.

### HasAuditLogsClaims

`func (o *UpdateAuthMethod) HasAuditLogsClaims() bool`
...
`func (o *UpdateAuthMethod) GetDeleteProtection() string`

GetDeleteProtection returns the DeleteProtection field if non-nil, zero value otherwise.

### GetDeleteProtectionOk

`func (o *UpdateAuthMethod) GetDeleteProtectionOk() (*string, bool)`
...
`func (o *UpdateAuthMethod) SetDeleteProtection(v string)`

SetDeleteProtection sets DeleteProtection field to given value.

### HasDeleteProtection

`func (o *UpdateAuthMethod) HasDeleteProtection() bool`
...
`func (o *UpdateAuthMethod) SetExpirationEventIn(v []string)`

SetExpirationEventIn sets ExpirationEventIn field to given value.

### HasExpirationEventIn

`func (o *UpdateAuthMethod) HasExpirationEventIn() bool`
...
`func (o *UpdateAuthMethod) SetProductType(v []string)`
