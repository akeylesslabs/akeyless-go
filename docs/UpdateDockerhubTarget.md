...
`func (o *UpdateDockerhubTarget) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *UpdateDockerhubTarget) GetLockOnReadOk() (*string, bool)`
...
`func (o *UpdateDockerhubTarget) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *UpdateDockerhubTarget) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *UpdateDockerhubTarget) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *UpdateDockerhubTarget) GetLockTtlOk() (*string, bool)`
...
`func (o *UpdateDockerhubTarget) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *UpdateDockerhubTarget) HasLockTtl() bool`
...
`func (o *UpdateDockerhubTarget) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *UpdateDockerhubTarget) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *UpdateDockerhubTarget) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *UpdateDockerhubTarget) HasRotateOnUnlock() bool`
