...
`func (o *TargetUpdateSectigo) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *TargetUpdateSectigo) GetLockOnReadOk() (*string, bool)`
...
`func (o *TargetUpdateSectigo) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *TargetUpdateSectigo) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *TargetUpdateSectigo) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *TargetUpdateSectigo) GetLockTtlOk() (*string, bool)`
...
`func (o *TargetUpdateSectigo) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *TargetUpdateSectigo) HasLockTtl() bool`
...
`func (o *TargetUpdateSectigo) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *TargetUpdateSectigo) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *TargetUpdateSectigo) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *TargetUpdateSectigo) HasRotateOnUnlock() bool`
