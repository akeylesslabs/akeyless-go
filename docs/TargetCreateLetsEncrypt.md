...
`func (o *TargetCreateLetsEncrypt) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *TargetCreateLetsEncrypt) GetLockOnReadOk() (*string, bool)`
...
`func (o *TargetCreateLetsEncrypt) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *TargetCreateLetsEncrypt) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *TargetCreateLetsEncrypt) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *TargetCreateLetsEncrypt) GetLockTtlOk() (*string, bool)`
...
`func (o *TargetCreateLetsEncrypt) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *TargetCreateLetsEncrypt) HasLockTtl() bool`
...
`func (o *TargetCreateLetsEncrypt) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *TargetCreateLetsEncrypt) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *TargetCreateLetsEncrypt) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *TargetCreateLetsEncrypt) HasRotateOnUnlock() bool`
