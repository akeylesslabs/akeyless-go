...
`func (o *TargetCreateGitlab) GetDeleteProtection() string`

GetDeleteProtection returns the DeleteProtection field if non-nil, zero value otherwise.

### GetDeleteProtectionOk

`func (o *TargetCreateGitlab) GetDeleteProtectionOk() (*string, bool)`
...
`func (o *TargetCreateGitlab) SetDeleteProtection(v string)`

SetDeleteProtection sets DeleteProtection field to given value.

### HasDeleteProtection

`func (o *TargetCreateGitlab) HasDeleteProtection() bool`
...
`func (o *TargetCreateGitlab) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *TargetCreateGitlab) GetLockOnReadOk() (*string, bool)`
...
`func (o *TargetCreateGitlab) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *TargetCreateGitlab) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *TargetCreateGitlab) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *TargetCreateGitlab) GetLockTtlOk() (*string, bool)`
...
`func (o *TargetCreateGitlab) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *TargetCreateGitlab) HasLockTtl() bool`
...
`func (o *TargetCreateGitlab) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *TargetCreateGitlab) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *TargetCreateGitlab) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *TargetCreateGitlab) HasRotateOnUnlock() bool`
