...
`func (o *RotatedSecretCreateF5BigIp) GetEnableAgenticRuntimeAuthority() bool`
...
`func (o *RotatedSecretCreateF5BigIp) GetEnableAgenticRuntimeAuthorityOk() (*bool, bool)`
...
`func (o *RotatedSecretCreateF5BigIp) SetEnableAiQuorum(v bool)`

SetEnableAiQuorum sets EnableAiQuorum field to given value.

### HasEnableAiQuorum

`func (o *RotatedSecretCreateF5BigIp) HasEnableAiQuorum() bool`
...
`func (o *RotatedSecretCreateF5BigIp) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *RotatedSecretCreateF5BigIp) GetLockOnReadOk() (*string, bool)`
...
`func (o *RotatedSecretCreateF5BigIp) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *RotatedSecretCreateF5BigIp) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *RotatedSecretCreateF5BigIp) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *RotatedSecretCreateF5BigIp) GetLockTtlOk() (*string, bool)`
...
`func (o *RotatedSecretCreateF5BigIp) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *RotatedSecretCreateF5BigIp) HasLockTtl() bool`
...
`func (o *RotatedSecretCreateF5BigIp) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *RotatedSecretCreateF5BigIp) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *RotatedSecretCreateF5BigIp) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *RotatedSecretCreateF5BigIp) HasRotateOnUnlock() bool`
