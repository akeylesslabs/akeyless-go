...
`func (o *DynamicSecretUpdateChef) GetEnableAgenticRuntimeAuthority() bool`
...
`func (o *DynamicSecretUpdateChef) GetEnableAgenticRuntimeAuthorityOk() (*bool, bool)`
...
`func (o *DynamicSecretUpdateChef) SetEnableAiQuorum(v bool)`

SetEnableAiQuorum sets EnableAiQuorum field to given value.

### HasEnableAiQuorum

`func (o *DynamicSecretUpdateChef) HasEnableAiQuorum() bool`

HasEnableAiQuorum returns a boolean if a field has been set.

### GetInputRule

`func (o *DynamicSecretUpdateChef) GetInputRule() []string`

GetInputRule returns the InputRule field if non-nil, zero value otherwise.

### GetInputRuleOk

`func (o *DynamicSecretUpdateChef) GetInputRuleOk() (*[]string, bool)`
...
`func (o *DynamicSecretUpdateChef) SetInputRule(v []string)`

SetInputRule sets InputRule field to given value.

### HasInputRule

`func (o *DynamicSecretUpdateChef) HasInputRule() bool`
...
`func (o *DynamicSecretUpdateChef) GetOutputRule() []string`

GetOutputRule returns the OutputRule field if non-nil, zero value otherwise.

### GetOutputRuleOk

`func (o *DynamicSecretUpdateChef) GetOutputRuleOk() (*[]string, bool)`
...
`func (o *DynamicSecretUpdateChef) SetOutputRule(v []string)`

SetOutputRule sets OutputRule field to given value.

### HasOutputRule

`func (o *DynamicSecretUpdateChef) HasOutputRule() bool`
...
`func (o *DynamicSecretUpdateChef) GetUseCapitalLetters() string`

GetUseCapitalLetters returns the UseCapitalLetters field if non-nil, zero value otherwise.

### GetUseCapitalLettersOk

`func (o *DynamicSecretUpdateChef) GetUseCapitalLettersOk() (*string, bool)`
...
`func (o *DynamicSecretUpdateChef) SetUseLowerLetters(v string)`

SetUseLowerLetters sets UseLowerLetters field to given value.

### HasUseLowerLetters

`func (o *DynamicSecretUpdateChef) HasUseLowerLetters() bool`

HasUseLowerLetters returns a boolean if a field has been set.

### GetUseNumbers

`func (o *DynamicSecretUpdateChef) GetUseNumbers() string`

GetUseNumbers returns the UseNumbers field if non-nil, zero value otherwise.

### GetUseNumbersOk

`func (o *DynamicSecretUpdateChef) GetUseNumbersOk() (*string, bool)`
...
`func (o *DynamicSecretUpdateChef) SetUseSpecialCharacters(v string)`

SetUseSpecialCharacters sets UseSpecialCharacters field to given value.

### HasUseSpecialCharacters

`func (o *DynamicSecretUpdateChef) HasUseSpecialCharacters() bool`
