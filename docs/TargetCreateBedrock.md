...
`func (o *TargetCreateBedrock) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *TargetCreateBedrock) GetLockOnReadOk() (*string, bool)`
...
`func (o *TargetCreateBedrock) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *TargetCreateBedrock) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *TargetCreateBedrock) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *TargetCreateBedrock) GetLockTtlOk() (*string, bool)`
...
`func (o *TargetCreateBedrock) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *TargetCreateBedrock) HasLockTtl() bool`
...
`func (o *TargetCreateBedrock) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *TargetCreateBedrock) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *TargetCreateBedrock) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *TargetCreateBedrock) HasRotateOnUnlock() bool`
