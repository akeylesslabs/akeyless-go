...
`func (o *UpdateEKSTarget) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *UpdateEKSTarget) GetLockOnReadOk() (*string, bool)`
...
`func (o *UpdateEKSTarget) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *UpdateEKSTarget) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *UpdateEKSTarget) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *UpdateEKSTarget) GetLockTtlOk() (*string, bool)`
...
`func (o *UpdateEKSTarget) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *UpdateEKSTarget) HasLockTtl() bool`
...
`func (o *UpdateEKSTarget) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *UpdateEKSTarget) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *UpdateEKSTarget) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *UpdateEKSTarget) HasRotateOnUnlock() bool`
