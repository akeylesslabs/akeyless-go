...
`func (o *UpdateGcpTarget) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *UpdateGcpTarget) GetLockOnReadOk() (*string, bool)`
...
`func (o *UpdateGcpTarget) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *UpdateGcpTarget) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *UpdateGcpTarget) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *UpdateGcpTarget) GetLockTtlOk() (*string, bool)`
...
`func (o *UpdateGcpTarget) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *UpdateGcpTarget) HasLockTtl() bool`
...
`func (o *UpdateGcpTarget) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *UpdateGcpTarget) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *UpdateGcpTarget) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *UpdateGcpTarget) HasRotateOnUnlock() bool`
