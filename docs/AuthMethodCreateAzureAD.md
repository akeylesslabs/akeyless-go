...
`func (o *AuthMethodCreateAzureAD) GetAllowedClientType() []string`

GetAllowedClientType returns the AllowedClientType field if non-nil, zero value otherwise.

### GetAllowedClientTypeOk

`func (o *AuthMethodCreateAzureAD) GetAllowedClientTypeOk() (*[]string, bool)`
...
`func (o *AuthMethodCreateAzureAD) SetAllowedClientType(v []string)`

SetAllowedClientType sets AllowedClientType field to given value.

### HasAllowedClientType

`func (o *AuthMethodCreateAzureAD) HasAllowedClientType() bool`
