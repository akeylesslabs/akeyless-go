...
`func (o *UpdateRabbitMQTarget) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *UpdateRabbitMQTarget) GetLockOnReadOk() (*string, bool)`
...
`func (o *UpdateRabbitMQTarget) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *UpdateRabbitMQTarget) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *UpdateRabbitMQTarget) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *UpdateRabbitMQTarget) GetLockTtlOk() (*string, bool)`
...
`func (o *UpdateRabbitMQTarget) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *UpdateRabbitMQTarget) HasLockTtl() bool`
...
`func (o *UpdateRabbitMQTarget) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *UpdateRabbitMQTarget) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *UpdateRabbitMQTarget) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *UpdateRabbitMQTarget) HasRotateOnUnlock() bool`
