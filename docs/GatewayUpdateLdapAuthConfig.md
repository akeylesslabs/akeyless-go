...
**LdapCaCert** | Pointer to **string** | The CA Cert (in PEM format) to use to call into the ldap API server | [optional] 
...
**SigningKeyData** | Pointer to **string** | The private key (in PEM format) associated with the public key defined in the Ldap auth | [optional] 
