...
`func (o *TargetUpdateWeb) GetDeleteProtection() string`

GetDeleteProtection returns the DeleteProtection field if non-nil, zero value otherwise.

### GetDeleteProtectionOk

`func (o *TargetUpdateWeb) GetDeleteProtectionOk() (*string, bool)`
...
`func (o *TargetUpdateWeb) SetDeleteProtection(v string)`

SetDeleteProtection sets DeleteProtection field to given value.

### HasDeleteProtection

`func (o *TargetUpdateWeb) HasDeleteProtection() bool`
...
`func (o *TargetUpdateWeb) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *TargetUpdateWeb) GetLockOnReadOk() (*string, bool)`
...
`func (o *TargetUpdateWeb) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *TargetUpdateWeb) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *TargetUpdateWeb) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *TargetUpdateWeb) GetLockTtlOk() (*string, bool)`
...
`func (o *TargetUpdateWeb) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *TargetUpdateWeb) HasLockTtl() bool`
...
`func (o *TargetUpdateWeb) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *TargetUpdateWeb) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *TargetUpdateWeb) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *TargetUpdateWeb) HasRotateOnUnlock() bool`
