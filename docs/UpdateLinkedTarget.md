...
------------ | ------------- | ------------- | -------------
**AddHosts** | Pointer to **string** | Comma separated list of new hosts that will be added to the Linked Target hosts. | [optional] 
...
`func NewUpdateLinkedTarget(hosts string, name string, ) *UpdateLinkedTarget`
...
`func (o *UpdateLinkedTarget) GetComment() string`

GetComment returns the Comment field if non-nil, zero value otherwise.

### GetCommentOk

`func (o *UpdateLinkedTarget) GetCommentOk() (*string, bool)`
...
`func (o *UpdateLinkedTarget) SetComment(v string)`

SetComment sets Comment field to given value.

### HasComment

`func (o *UpdateLinkedTarget) HasComment() bool`
