...
`func (o *CreateGKETarget) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *CreateGKETarget) GetLockOnReadOk() (*string, bool)`
...
`func (o *CreateGKETarget) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *CreateGKETarget) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *CreateGKETarget) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *CreateGKETarget) GetLockTtlOk() (*string, bool)`
...
`func (o *CreateGKETarget) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *CreateGKETarget) HasLockTtl() bool`
...
`func (o *CreateGKETarget) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *CreateGKETarget) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *CreateGKETarget) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *CreateGKETarget) HasRotateOnUnlock() bool`
