...
`func (o *TargetCreateDockerhub) GetDeleteProtection() string`

GetDeleteProtection returns the DeleteProtection field if non-nil, zero value otherwise.

### GetDeleteProtectionOk

`func (o *TargetCreateDockerhub) GetDeleteProtectionOk() (*string, bool)`
...
`func (o *TargetCreateDockerhub) SetDeleteProtection(v string)`

SetDeleteProtection sets DeleteProtection field to given value.

### HasDeleteProtection

`func (o *TargetCreateDockerhub) HasDeleteProtection() bool`
...
`func (o *TargetCreateDockerhub) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *TargetCreateDockerhub) GetLockOnReadOk() (*string, bool)`
...
`func (o *TargetCreateDockerhub) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *TargetCreateDockerhub) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *TargetCreateDockerhub) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *TargetCreateDockerhub) GetLockTtlOk() (*string, bool)`
...
`func (o *TargetCreateDockerhub) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *TargetCreateDockerhub) HasLockTtl() bool`
...
`func (o *TargetCreateDockerhub) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *TargetCreateDockerhub) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *TargetCreateDockerhub) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *TargetCreateDockerhub) HasRotateOnUnlock() bool`
