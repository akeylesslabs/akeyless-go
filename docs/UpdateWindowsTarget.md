...
`func (o *UpdateWindowsTarget) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *UpdateWindowsTarget) GetLockOnReadOk() (*string, bool)`
...
`func (o *UpdateWindowsTarget) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *UpdateWindowsTarget) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *UpdateWindowsTarget) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *UpdateWindowsTarget) GetLockTtlOk() (*string, bool)`
...
`func (o *UpdateWindowsTarget) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *UpdateWindowsTarget) HasLockTtl() bool`
...
`func (o *UpdateWindowsTarget) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *UpdateWindowsTarget) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *UpdateWindowsTarget) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *UpdateWindowsTarget) HasRotateOnUnlock() bool`
