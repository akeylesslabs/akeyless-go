...
`func (o *UpdateAuthMethodCert) GetAllowedClientType() []string`

GetAllowedClientType returns the AllowedClientType field if non-nil, zero value otherwise.

### GetAllowedClientTypeOk

`func (o *UpdateAuthMethodCert) GetAllowedClientTypeOk() (*[]string, bool)`
...
`func (o *UpdateAuthMethodCert) SetAllowedClientType(v []string)`

SetAllowedClientType sets AllowedClientType field to given value.

### HasAllowedClientType

`func (o *UpdateAuthMethodCert) HasAllowedClientType() bool`
