...
`func (o *UpdateAuthMethodGCP) GetAllowedClientType() []string`

GetAllowedClientType returns the AllowedClientType field if non-nil, zero value otherwise.

### GetAllowedClientTypeOk

`func (o *UpdateAuthMethodGCP) GetAllowedClientTypeOk() (*[]string, bool)`
...
`func (o *UpdateAuthMethodGCP) SetAllowedClientType(v []string)`

SetAllowedClientType sets AllowedClientType field to given value.

### HasAllowedClientType

`func (o *UpdateAuthMethodGCP) HasAllowedClientType() bool`
