...
`func (o *CreateGlobalSignTarget) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *CreateGlobalSignTarget) GetLockOnReadOk() (*string, bool)`
...
`func (o *CreateGlobalSignTarget) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *CreateGlobalSignTarget) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *CreateGlobalSignTarget) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *CreateGlobalSignTarget) GetLockTtlOk() (*string, bool)`
...
`func (o *CreateGlobalSignTarget) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *CreateGlobalSignTarget) HasLockTtl() bool`
...
`func (o *CreateGlobalSignTarget) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *CreateGlobalSignTarget) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *CreateGlobalSignTarget) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *CreateGlobalSignTarget) HasRotateOnUnlock() bool`
