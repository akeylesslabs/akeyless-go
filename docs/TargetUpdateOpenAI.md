...
`func (o *TargetUpdateOpenAI) GetDeleteProtection() string`

GetDeleteProtection returns the DeleteProtection field if non-nil, zero value otherwise.

### GetDeleteProtectionOk

`func (o *TargetUpdateOpenAI) GetDeleteProtectionOk() (*string, bool)`
...
`func (o *TargetUpdateOpenAI) SetDeleteProtection(v string)`

SetDeleteProtection sets DeleteProtection field to given value.

### HasDeleteProtection

`func (o *TargetUpdateOpenAI) HasDeleteProtection() bool`
...
`func (o *TargetUpdateOpenAI) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *TargetUpdateOpenAI) GetLockOnReadOk() (*string, bool)`
...
`func (o *TargetUpdateOpenAI) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *TargetUpdateOpenAI) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *TargetUpdateOpenAI) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *TargetUpdateOpenAI) GetLockTtlOk() (*string, bool)`
...
`func (o *TargetUpdateOpenAI) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *TargetUpdateOpenAI) HasLockTtl() bool`
...
`func (o *TargetUpdateOpenAI) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *TargetUpdateOpenAI) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *TargetUpdateOpenAI) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *TargetUpdateOpenAI) HasRotateOnUnlock() bool`
