...
`func (o *AuthMethodUpdateLdap) GetAllowedClientType() []string`

GetAllowedClientType returns the AllowedClientType field if non-nil, zero value otherwise.

### GetAllowedClientTypeOk

`func (o *AuthMethodUpdateLdap) GetAllowedClientTypeOk() (*[]string, bool)`
...
`func (o *AuthMethodUpdateLdap) SetAllowedClientType(v []string)`

SetAllowedClientType sets AllowedClientType field to given value.

### HasAllowedClientType

`func (o *AuthMethodUpdateLdap) HasAllowedClientType() bool`
