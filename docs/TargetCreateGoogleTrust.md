...
`func (o *TargetCreateGoogleTrust) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *TargetCreateGoogleTrust) GetLockOnReadOk() (*string, bool)`
...
`func (o *TargetCreateGoogleTrust) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *TargetCreateGoogleTrust) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *TargetCreateGoogleTrust) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *TargetCreateGoogleTrust) GetLockTtlOk() (*string, bool)`
...
`func (o *TargetCreateGoogleTrust) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *TargetCreateGoogleTrust) HasLockTtl() bool`
...
`func (o *TargetCreateGoogleTrust) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *TargetCreateGoogleTrust) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *TargetCreateGoogleTrust) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *TargetCreateGoogleTrust) HasRotateOnUnlock() bool`
