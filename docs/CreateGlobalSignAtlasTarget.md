...
`func (o *CreateGlobalSignAtlasTarget) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *CreateGlobalSignAtlasTarget) GetLockOnReadOk() (*string, bool)`
...
`func (o *CreateGlobalSignAtlasTarget) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *CreateGlobalSignAtlasTarget) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *CreateGlobalSignAtlasTarget) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *CreateGlobalSignAtlasTarget) GetLockTtlOk() (*string, bool)`
...
`func (o *CreateGlobalSignAtlasTarget) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *CreateGlobalSignAtlasTarget) HasLockTtl() bool`
...
`func (o *CreateGlobalSignAtlasTarget) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *CreateGlobalSignAtlasTarget) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *CreateGlobalSignAtlasTarget) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *CreateGlobalSignAtlasTarget) HasRotateOnUnlock() bool`
