...
`func (o *CreateAuthMethodGCP) GetAllowedClientType() []string`

GetAllowedClientType returns the AllowedClientType field if non-nil, zero value otherwise.

### GetAllowedClientTypeOk

`func (o *CreateAuthMethodGCP) GetAllowedClientTypeOk() (*[]string, bool)`
...
`func (o *CreateAuthMethodGCP) SetAllowedClientType(v []string)`

SetAllowedClientType sets AllowedClientType field to given value.

### HasAllowedClientType

`func (o *CreateAuthMethodGCP) HasAllowedClientType() bool`
