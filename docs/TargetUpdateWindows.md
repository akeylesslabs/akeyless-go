...
`func (o *TargetUpdateWindows) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *TargetUpdateWindows) GetLockOnReadOk() (*string, bool)`
...
`func (o *TargetUpdateWindows) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *TargetUpdateWindows) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *TargetUpdateWindows) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *TargetUpdateWindows) GetLockTtlOk() (*string, bool)`
...
`func (o *TargetUpdateWindows) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *TargetUpdateWindows) HasLockTtl() bool`
...
`func (o *TargetUpdateWindows) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *TargetUpdateWindows) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *TargetUpdateWindows) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *TargetUpdateWindows) HasRotateOnUnlock() bool`
