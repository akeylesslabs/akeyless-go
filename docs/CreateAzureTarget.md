...
`func (o *CreateAzureTarget) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *CreateAzureTarget) GetLockOnReadOk() (*string, bool)`
...
`func (o *CreateAzureTarget) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *CreateAzureTarget) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *CreateAzureTarget) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *CreateAzureTarget) GetLockTtlOk() (*string, bool)`
...
`func (o *CreateAzureTarget) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *CreateAzureTarget) HasLockTtl() bool`
...
`func (o *CreateAzureTarget) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *CreateAzureTarget) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *CreateAzureTarget) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *CreateAzureTarget) HasRotateOnUnlock() bool`
