...
`func (o *CreateDockerhubTarget) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *CreateDockerhubTarget) GetLockOnReadOk() (*string, bool)`
...
`func (o *CreateDockerhubTarget) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *CreateDockerhubTarget) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *CreateDockerhubTarget) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *CreateDockerhubTarget) GetLockTtlOk() (*string, bool)`
...
`func (o *CreateDockerhubTarget) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *CreateDockerhubTarget) HasLockTtl() bool`
...
`func (o *CreateDockerhubTarget) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *CreateDockerhubTarget) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *CreateDockerhubTarget) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *CreateDockerhubTarget) HasRotateOnUnlock() bool`
