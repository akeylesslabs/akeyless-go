...
`func (o *TargetCreateSalesforce) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *TargetCreateSalesforce) GetLockOnReadOk() (*string, bool)`
...
`func (o *TargetCreateSalesforce) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *TargetCreateSalesforce) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *TargetCreateSalesforce) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *TargetCreateSalesforce) GetLockTtlOk() (*string, bool)`
...
`func (o *TargetCreateSalesforce) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *TargetCreateSalesforce) HasLockTtl() bool`
...
`func (o *TargetCreateSalesforce) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *TargetCreateSalesforce) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *TargetCreateSalesforce) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *TargetCreateSalesforce) HasRotateOnUnlock() bool`
