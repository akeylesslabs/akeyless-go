...
`func (o *GatewayCreateProducerMSSQL) GetEnableAgenticRuntimeAuthority() bool`
...
`func (o *GatewayCreateProducerMSSQL) GetEnableAgenticRuntimeAuthorityOk() (*bool, bool)`
...
`func (o *GatewayCreateProducerMSSQL) SetEnableAiQuorum(v bool)`

SetEnableAiQuorum sets EnableAiQuorum field to given value.

### HasEnableAiQuorum

`func (o *GatewayCreateProducerMSSQL) HasEnableAiQuorum() bool`

HasEnableAiQuorum returns a boolean if a field has been set.

### GetInputRule

`func (o *GatewayCreateProducerMSSQL) GetInputRule() []string`

GetInputRule returns the InputRule field if non-nil, zero value otherwise.

### GetInputRuleOk

`func (o *GatewayCreateProducerMSSQL) GetInputRuleOk() (*[]string, bool)`
...
`func (o *GatewayCreateProducerMSSQL) SetInputRule(v []string)`

SetInputRule sets InputRule field to given value.

### HasInputRule

`func (o *GatewayCreateProducerMSSQL) HasInputRule() bool`
...
`func (o *GatewayCreateProducerMSSQL) GetMssqlAllowedDbNames() string`

GetMssqlAllowedDbNames returns the MssqlAllowedDbNames field if non-nil, zero value otherwise.

### GetMssqlAllowedDbNamesOk

`func (o *GatewayCreateProducerMSSQL) GetMssqlAllowedDbNamesOk() (*string, bool)`
...
`func (o *GatewayCreateProducerMSSQL) SetMssqlAllowedDbNames(v string)`

SetMssqlAllowedDbNames sets MssqlAllowedDbNames field to given value.

### HasMssqlAllowedDbNames

`func (o *GatewayCreateProducerMSSQL) HasMssqlAllowedDbNames() bool`
...
`func (o *GatewayCreateProducerMSSQL) GetOutputRule() []string`

GetOutputRule returns the OutputRule field if non-nil, zero value otherwise.

### GetOutputRuleOk

`func (o *GatewayCreateProducerMSSQL) GetOutputRuleOk() (*[]string, bool)`
...
`func (o *GatewayCreateProducerMSSQL) SetOutputRule(v []string)`

SetOutputRule sets OutputRule field to given value.

### HasOutputRule

`func (o *GatewayCreateProducerMSSQL) HasOutputRule() bool`
...
`func (o *GatewayCreateProducerMSSQL) GetSkipDryRun() bool`

GetSkipDryRun returns the SkipDryRun field if non-nil, zero value otherwise.

### GetSkipDryRunOk

`func (o *GatewayCreateProducerMSSQL) GetSkipDryRunOk() (*bool, bool)`
...
`func (o *GatewayCreateProducerMSSQL) SetSkipDryRun(v bool)`
...
`func (o *GatewayCreateProducerMSSQL) GetUseCapitalLetters() string`

GetUseCapitalLetters returns the UseCapitalLetters field if non-nil, zero value otherwise.

### GetUseCapitalLettersOk

`func (o *GatewayCreateProducerMSSQL) GetUseCapitalLettersOk() (*string, bool)`
...
`func (o *GatewayCreateProducerMSSQL) SetUseLowerLetters(v string)`

SetUseLowerLetters sets UseLowerLetters field to given value.

### HasUseLowerLetters

`func (o *GatewayCreateProducerMSSQL) HasUseLowerLetters() bool`

HasUseLowerLetters returns a boolean if a field has been set.

### GetUseNumbers

`func (o *GatewayCreateProducerMSSQL) GetUseNumbers() string`

GetUseNumbers returns the UseNumbers field if non-nil, zero value otherwise.

### GetUseNumbersOk

`func (o *GatewayCreateProducerMSSQL) GetUseNumbersOk() (*string, bool)`
...
`func (o *GatewayCreateProducerMSSQL) SetUseSpecialCharacters(v string)`

SetUseSpecialCharacters sets UseSpecialCharacters field to given value.

### HasUseSpecialCharacters

`func (o *GatewayCreateProducerMSSQL) HasUseSpecialCharacters() bool`
