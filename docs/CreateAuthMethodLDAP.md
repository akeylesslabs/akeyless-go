...
`func (o *CreateAuthMethodLDAP) GetAllowedClientType() []string`

GetAllowedClientType returns the AllowedClientType field if non-nil, zero value otherwise.

### GetAllowedClientTypeOk

`func (o *CreateAuthMethodLDAP) GetAllowedClientTypeOk() (*[]string, bool)`
...
`func (o *CreateAuthMethodLDAP) SetAllowedClientType(v []string)`

SetAllowedClientType sets AllowedClientType field to given value.

### HasAllowedClientType

`func (o *CreateAuthMethodLDAP) HasAllowedClientType() bool`
