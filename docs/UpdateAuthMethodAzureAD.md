...
`func (o *UpdateAuthMethodAzureAD) GetAllowedClientType() []string`

GetAllowedClientType returns the AllowedClientType field if non-nil, zero value otherwise.

### GetAllowedClientTypeOk

`func (o *UpdateAuthMethodAzureAD) GetAllowedClientTypeOk() (*[]string, bool)`
...
`func (o *UpdateAuthMethodAzureAD) SetAllowedClientType(v []string)`

SetAllowedClientType sets AllowedClientType field to given value.

### HasAllowedClientType

`func (o *UpdateAuthMethodAzureAD) HasAllowedClientType() bool`
...
`func (o *UpdateAuthMethodAzureAD) GetAuditLogsClaims() []string`

GetAuditLogsClaims returns the AuditLogsClaims field if non-nil, zero value otherwise.

### GetAuditLogsClaimsOk

`func (o *UpdateAuthMethodAzureAD) GetAuditLogsClaimsOk() (*[]string, bool)`
...
`func (o *UpdateAuthMethodAzureAD) SetAuditLogsClaims(v []string)`

SetAuditLogsClaims sets AuditLogsClaims field to given value.

### HasAuditLogsClaims

`func (o *UpdateAuthMethodAzureAD) HasAuditLogsClaims() bool`
...
`func (o *UpdateAuthMethodAzureAD) GetDeleteProtection() string`

GetDeleteProtection returns the DeleteProtection field if non-nil, zero value otherwise.

### GetDeleteProtectionOk

`func (o *UpdateAuthMethodAzureAD) GetDeleteProtectionOk() (*string, bool)`
...
`func (o *UpdateAuthMethodAzureAD) SetDeleteProtection(v string)`

SetDeleteProtection sets DeleteProtection field to given value.

### HasDeleteProtection

`func (o *UpdateAuthMethodAzureAD) HasDeleteProtection() bool`
...
`func (o *UpdateAuthMethodAzureAD) GetExpirationEventIn() []string`

GetExpirationEventIn returns the ExpirationEventIn field if non-nil, zero value otherwise.

### GetExpirationEventInOk

`func (o *UpdateAuthMethodAzureAD) GetExpirationEventInOk() (*[]string, bool)`
...
`func (o *UpdateAuthMethodAzureAD) SetExpirationEventIn(v []string)`

SetExpirationEventIn sets ExpirationEventIn field to given value.

### HasExpirationEventIn

`func (o *UpdateAuthMethodAzureAD) HasExpirationEventIn() bool`
