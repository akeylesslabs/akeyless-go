...
func main() {
    body := *openapiclient.NewAllowedAccessArgs("AccessId_example", "Name_example") // AllowedAccessArgs | 
...
func main() {
    body := *openapiclient.NewAllowedAccessDeleteArgs("Name_example") // AllowedAccessDeleteArgs | 
...
func main() {
    body := *openapiclient.NewAllowedAccessUpdateArgs("AccessId_example", "Name_example") // AllowedAccessUpdateArgs | 
