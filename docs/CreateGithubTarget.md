...
`func (o *CreateGithubTarget) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *CreateGithubTarget) GetLockOnReadOk() (*string, bool)`
...
`func (o *CreateGithubTarget) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *CreateGithubTarget) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *CreateGithubTarget) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *CreateGithubTarget) GetLockTtlOk() (*string, bool)`
...
`func (o *CreateGithubTarget) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *CreateGithubTarget) HasLockTtl() bool`
...
`func (o *CreateGithubTarget) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *CreateGithubTarget) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *CreateGithubTarget) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *CreateGithubTarget) HasRotateOnUnlock() bool`
