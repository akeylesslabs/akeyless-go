...
### GetGkeServiceAccountKeyFilePath

`func (o *GatewayCreateProducerGke) GetGkeServiceAccountKeyFilePath() string`

GetGkeServiceAccountKeyFilePath returns the GkeServiceAccountKeyFilePath field if non-nil, zero value otherwise.

### GetGkeServiceAccountKeyFilePathOk

`func (o *GatewayCreateProducerGke) GetGkeServiceAccountKeyFilePathOk() (*string, bool)`

GetGkeServiceAccountKeyFilePathOk returns a tuple with the GkeServiceAccountKeyFilePath field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetGkeServiceAccountKeyFilePath

`func (o *GatewayCreateProducerGke) SetGkeServiceAccountKeyFilePath(v string)`

SetGkeServiceAccountKeyFilePath sets GkeServiceAccountKeyFilePath field to given value.
