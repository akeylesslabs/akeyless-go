...
`func (o *UpdateGodaddyTarget) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *UpdateGodaddyTarget) GetLockOnReadOk() (*string, bool)`
...
`func (o *UpdateGodaddyTarget) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *UpdateGodaddyTarget) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *UpdateGodaddyTarget) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *UpdateGodaddyTarget) GetLockTtlOk() (*string, bool)`
...
`func (o *UpdateGodaddyTarget) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *UpdateGodaddyTarget) HasLockTtl() bool`
...
`func (o *UpdateGodaddyTarget) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *UpdateGodaddyTarget) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *UpdateGodaddyTarget) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *UpdateGodaddyTarget) HasRotateOnUnlock() bool`
