...
`func (o *CreateAuthMethodAzureAD) GetAllowedClientType() []string`

GetAllowedClientType returns the AllowedClientType field if non-nil, zero value otherwise.

### GetAllowedClientTypeOk

`func (o *CreateAuthMethodAzureAD) GetAllowedClientTypeOk() (*[]string, bool)`
...
`func (o *CreateAuthMethodAzureAD) SetAllowedClientType(v []string)`

SetAllowedClientType sets AllowedClientType field to given value.

### HasAllowedClientType

`func (o *CreateAuthMethodAzureAD) HasAllowedClientType() bool`
...
`func (o *CreateAuthMethodAzureAD) GetExpirationEventIn() []string`

GetExpirationEventIn returns the ExpirationEventIn field if non-nil, zero value otherwise.

### GetExpirationEventInOk

`func (o *CreateAuthMethodAzureAD) GetExpirationEventInOk() (*[]string, bool)`
...
`func (o *CreateAuthMethodAzureAD) SetExpirationEventIn(v []string)`

SetExpirationEventIn sets ExpirationEventIn field to given value.

### HasExpirationEventIn

`func (o *CreateAuthMethodAzureAD) HasExpirationEventIn() bool`
...
`func (o *CreateAuthMethodAzureAD) GetUniqueIdentifier() string`

GetUniqueIdentifier returns the UniqueIdentifier field if non-nil, zero value otherwise.

### GetUniqueIdentifierOk

`func (o *CreateAuthMethodAzureAD) GetUniqueIdentifierOk() (*string, bool)`
...
`func (o *CreateAuthMethodAzureAD) SetUniqueIdentifier(v string)`

SetUniqueIdentifier sets UniqueIdentifier field to given value.

### HasUniqueIdentifier

`func (o *CreateAuthMethodAzureAD) HasUniqueIdentifier() bool`
