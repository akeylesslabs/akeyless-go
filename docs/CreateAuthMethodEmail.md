...
`func (o *CreateAuthMethodEmail) GetAllowedClientType() []string`

GetAllowedClientType returns the AllowedClientType field if non-nil, zero value otherwise.

### GetAllowedClientTypeOk

`func (o *CreateAuthMethodEmail) GetAllowedClientTypeOk() (*[]string, bool)`
...
`func (o *CreateAuthMethodEmail) SetAllowedClientType(v []string)`

SetAllowedClientType sets AllowedClientType field to given value.

### HasAllowedClientType

`func (o *CreateAuthMethodEmail) HasAllowedClientType() bool`
...
`func (o *CreateAuthMethodEmail) GetDeleteProtection() string`

GetDeleteProtection returns the DeleteProtection field if non-nil, zero value otherwise.

### GetDeleteProtectionOk

`func (o *CreateAuthMethodEmail) GetDeleteProtectionOk() (*string, bool)`
...
`func (o *CreateAuthMethodEmail) SetDeleteProtection(v string)`

SetDeleteProtection sets DeleteProtection field to given value.

### HasDeleteProtection

`func (o *CreateAuthMethodEmail) HasDeleteProtection() bool`
...
`func (o *CreateAuthMethodEmail) GetEnableMfa() string`

GetEnableMfa returns the EnableMfa field if non-nil, zero value otherwise.

### GetEnableMfaOk

`func (o *CreateAuthMethodEmail) GetEnableMfaOk() (*string, bool)`
...
`func (o *CreateAuthMethodEmail) SetExpirationEventIn(v []string)`

SetExpirationEventIn sets ExpirationEventIn field to given value.

### HasExpirationEventIn

`func (o *CreateAuthMethodEmail) HasExpirationEventIn() bool`
...
`func (o *CreateAuthMethodEmail) GetMfaType() string`

GetMfaType returns the MfaType field if non-nil, zero value otherwise.

### GetMfaTypeOk

`func (o *CreateAuthMethodEmail) GetMfaTypeOk() (*string, bool)`
...
`func (o *CreateAuthMethodEmail) SetMfaType(v string)`

SetMfaType sets MfaType field to given value.

### HasMfaType

`func (o *CreateAuthMethodEmail) HasMfaType() bool`
