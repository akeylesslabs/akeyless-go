...
**AutoGeneratedFolder** | Pointer to **string** |  | [optional] 
...
**CreateCertUsingPki** | Pointer to **bool** |  | [optional] 
...
**RootFirstInChain** | Pointer to **bool** |  | [optional] 
**ShouldStop** | Pointer to **string** | TODO delete this after migration | [optional] 
**SignerKeyName** | Pointer to **string** |  | [optional] 
**StorePrivateKey** | Pointer to **bool** |  | [optional] 
...
### GetCreateCertUsingPki

`func (o *DSProducerDetails) GetCreateCertUsingPki() bool`

GetCreateCertUsingPki returns the CreateCertUsingPki field if non-nil, zero value otherwise.

### GetCreateCertUsingPkiOk

`func (o *DSProducerDetails) GetCreateCertUsingPkiOk() (*bool, bool)`

GetCreateCertUsingPkiOk returns a tuple with the CreateCertUsingPki field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetCreateCertUsingPki

`func (o *DSProducerDetails) SetCreateCertUsingPki(v bool)`

SetCreateCertUsingPki sets CreateCertUsingPki field to given value.

### HasCreateCertUsingPki
