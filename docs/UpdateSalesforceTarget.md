...
`func (o *UpdateSalesforceTarget) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *UpdateSalesforceTarget) GetLockOnReadOk() (*string, bool)`
...
`func (o *UpdateSalesforceTarget) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *UpdateSalesforceTarget) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *UpdateSalesforceTarget) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *UpdateSalesforceTarget) GetLockTtlOk() (*string, bool)`
...
`func (o *UpdateSalesforceTarget) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *UpdateSalesforceTarget) HasLockTtl() bool`
...
`func (o *UpdateSalesforceTarget) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *UpdateSalesforceTarget) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *UpdateSalesforceTarget) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *UpdateSalesforceTarget) HasRotateOnUnlock() bool`
