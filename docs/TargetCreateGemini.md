...
`func (o *TargetCreateGemini) GetDeleteProtection() string`

GetDeleteProtection returns the DeleteProtection field if non-nil, zero value otherwise.

### GetDeleteProtectionOk

`func (o *TargetCreateGemini) GetDeleteProtectionOk() (*string, bool)`
...
`func (o *TargetCreateGemini) SetDeleteProtection(v string)`

SetDeleteProtection sets DeleteProtection field to given value.

### HasDeleteProtection

`func (o *TargetCreateGemini) HasDeleteProtection() bool`
...
`func (o *TargetCreateGemini) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *TargetCreateGemini) GetLockOnReadOk() (*string, bool)`
...
`func (o *TargetCreateGemini) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *TargetCreateGemini) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *TargetCreateGemini) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *TargetCreateGemini) GetLockTtlOk() (*string, bool)`
...
`func (o *TargetCreateGemini) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *TargetCreateGemini) HasLockTtl() bool`
...
`func (o *TargetCreateGemini) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *TargetCreateGemini) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *TargetCreateGemini) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *TargetCreateGemini) HasRotateOnUnlock() bool`
