...
`func (o *RotatedSecretUpdateSsh) GetEnableAgenticRuntimeAuthority() bool`
...
`func (o *RotatedSecretUpdateSsh) GetEnableAgenticRuntimeAuthorityOk() (*bool, bool)`
...
`func (o *RotatedSecretUpdateSsh) SetEnableAiQuorum(v bool)`

SetEnableAiQuorum sets EnableAiQuorum field to given value.

### HasEnableAiQuorum

`func (o *RotatedSecretUpdateSsh) HasEnableAiQuorum() bool`
...
`func (o *RotatedSecretUpdateSsh) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *RotatedSecretUpdateSsh) GetLockOnReadOk() (*string, bool)`
...
`func (o *RotatedSecretUpdateSsh) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *RotatedSecretUpdateSsh) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *RotatedSecretUpdateSsh) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *RotatedSecretUpdateSsh) GetLockTtlOk() (*string, bool)`
...
`func (o *RotatedSecretUpdateSsh) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *RotatedSecretUpdateSsh) HasLockTtl() bool`
...
`func (o *RotatedSecretUpdateSsh) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *RotatedSecretUpdateSsh) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *RotatedSecretUpdateSsh) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *RotatedSecretUpdateSsh) HasRotateOnUnlock() bool`
...
`func (o *RotatedSecretUpdateSsh) GetSkipDryRun() bool`

GetSkipDryRun returns the SkipDryRun field if non-nil, zero value otherwise.

### GetSkipDryRunOk

`func (o *RotatedSecretUpdateSsh) GetSkipDryRunOk() (*bool, bool)`
...
`func (o *RotatedSecretUpdateSsh) SetSkipDryRun(v bool)`
