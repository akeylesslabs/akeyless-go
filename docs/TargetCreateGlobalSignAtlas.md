...
`func (o *TargetCreateGlobalSignAtlas) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *TargetCreateGlobalSignAtlas) GetLockOnReadOk() (*string, bool)`
...
`func (o *TargetCreateGlobalSignAtlas) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *TargetCreateGlobalSignAtlas) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *TargetCreateGlobalSignAtlas) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *TargetCreateGlobalSignAtlas) GetLockTtlOk() (*string, bool)`
...
`func (o *TargetCreateGlobalSignAtlas) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *TargetCreateGlobalSignAtlas) HasLockTtl() bool`
...
`func (o *TargetCreateGlobalSignAtlas) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *TargetCreateGlobalSignAtlas) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *TargetCreateGlobalSignAtlas) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *TargetCreateGlobalSignAtlas) HasRotateOnUnlock() bool`
