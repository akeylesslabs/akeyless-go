...
`func (o *UpdateHashiVaultTarget) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *UpdateHashiVaultTarget) GetLockOnReadOk() (*string, bool)`
...
`func (o *UpdateHashiVaultTarget) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *UpdateHashiVaultTarget) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *UpdateHashiVaultTarget) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *UpdateHashiVaultTarget) GetLockTtlOk() (*string, bool)`
...
`func (o *UpdateHashiVaultTarget) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *UpdateHashiVaultTarget) HasLockTtl() bool`
...
`func (o *UpdateHashiVaultTarget) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *UpdateHashiVaultTarget) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *UpdateHashiVaultTarget) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *UpdateHashiVaultTarget) HasRotateOnUnlock() bool`
