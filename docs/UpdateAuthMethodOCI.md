...
`func (o *UpdateAuthMethodOCI) GetAllowedClientType() []string`

GetAllowedClientType returns the AllowedClientType field if non-nil, zero value otherwise.

### GetAllowedClientTypeOk

`func (o *UpdateAuthMethodOCI) GetAllowedClientTypeOk() (*[]string, bool)`
...
`func (o *UpdateAuthMethodOCI) SetAuditLogsClaims(v []string)`

SetAuditLogsClaims sets AuditLogsClaims field to given value.

### HasAuditLogsClaims

`func (o *UpdateAuthMethodOCI) HasAuditLogsClaims() bool`
...
`func (o *UpdateAuthMethodOCI) GetDeleteProtection() string`

GetDeleteProtection returns the DeleteProtection field if non-nil, zero value otherwise.

### GetDeleteProtectionOk

`func (o *UpdateAuthMethodOCI) GetDeleteProtectionOk() (*string, bool)`
...
`func (o *UpdateAuthMethodOCI) SetDeleteProtection(v string)`

SetDeleteProtection sets DeleteProtection field to given value.

### HasDeleteProtection

`func (o *UpdateAuthMethodOCI) HasDeleteProtection() bool`
...
`func (o *UpdateAuthMethodOCI) GetExpirationEventIn() []string`

GetExpirationEventIn returns the ExpirationEventIn field if non-nil, zero value otherwise.

### GetExpirationEventInOk

`func (o *UpdateAuthMethodOCI) GetExpirationEventInOk() (*[]string, bool)`
...
`func (o *UpdateAuthMethodOCI) SetExpirationEventIn(v []string)`

SetExpirationEventIn sets ExpirationEventIn field to given value.

### HasExpirationEventIn

`func (o *UpdateAuthMethodOCI) HasExpirationEventIn() bool`
