...
`func (o *CreateAuthMethodAWSIAM) GetAllowedClientType() []string`

GetAllowedClientType returns the AllowedClientType field if non-nil, zero value otherwise.

### GetAllowedClientTypeOk

`func (o *CreateAuthMethodAWSIAM) GetAllowedClientTypeOk() (*[]string, bool)`
...
`func (o *CreateAuthMethodAWSIAM) SetAllowedClientType(v []string)`

SetAllowedClientType sets AllowedClientType field to given value.

### HasAllowedClientType

`func (o *CreateAuthMethodAWSIAM) HasAllowedClientType() bool`
