...
`func (o *CreateAuthMethodK8S) GetPassword() string`

GetPassword returns the Password field if non-nil, zero value otherwise.

### GetPasswordOk

`func (o *CreateAuthMethodK8S) GetPasswordOk() (*string, bool)`
...
`func (o *CreateAuthMethodK8S) SetPassword(v string)`
...
`func (o *CreateAuthMethodK8S) GetUsername() string`

GetUsername returns the Username field if non-nil, zero value otherwise.

### GetUsernameOk

`func (o *CreateAuthMethodK8S) GetUsernameOk() (*string, bool)`
...
`func (o *CreateAuthMethodK8S) SetUsername(v string)`

SetUsername sets Username field to given value.

### HasUsername

`func (o *CreateAuthMethodK8S) HasUsername() bool`
