...
`func (o *CreateAuthMethodK8S) GetAllowedClientType() []string`

GetAllowedClientType returns the AllowedClientType field if non-nil, zero value otherwise.

### GetAllowedClientTypeOk

`func (o *CreateAuthMethodK8S) GetAllowedClientTypeOk() (*[]string, bool)`
...
`func (o *CreateAuthMethodK8S) SetAllowedClientType(v []string)`

SetAllowedClientType sets AllowedClientType field to given value.

### HasAllowedClientType

`func (o *CreateAuthMethodK8S) HasAllowedClientType() bool`
...
`func (o *CreateAuthMethodK8S) GetExpirationEventIn() []string`

GetExpirationEventIn returns the ExpirationEventIn field if non-nil, zero value otherwise.

### GetExpirationEventInOk

`func (o *CreateAuthMethodK8S) GetExpirationEventInOk() (*[]string, bool)`
...
`func (o *CreateAuthMethodK8S) SetExpirationEventIn(v []string)`

SetExpirationEventIn sets ExpirationEventIn field to given value.

### HasExpirationEventIn

`func (o *CreateAuthMethodK8S) HasExpirationEventIn() bool`
