...
`func (o *UpdateGlobalSignAtlasTarget) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *UpdateGlobalSignAtlasTarget) GetLockOnReadOk() (*string, bool)`
...
`func (o *UpdateGlobalSignAtlasTarget) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *UpdateGlobalSignAtlasTarget) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *UpdateGlobalSignAtlasTarget) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *UpdateGlobalSignAtlasTarget) GetLockTtlOk() (*string, bool)`
...
`func (o *UpdateGlobalSignAtlasTarget) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *UpdateGlobalSignAtlasTarget) HasLockTtl() bool`
...
`func (o *UpdateGlobalSignAtlasTarget) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *UpdateGlobalSignAtlasTarget) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *UpdateGlobalSignAtlasTarget) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *UpdateGlobalSignAtlasTarget) HasRotateOnUnlock() bool`
