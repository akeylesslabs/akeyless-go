...
`func NewCreateAuthMethodOAuth2(name string, uniqueIdentifier string, ) *CreateAuthMethodOAuth2`
...
`func (o *CreateAuthMethodOAuth2) GetDeleteProtection() string`

GetDeleteProtection returns the DeleteProtection field if non-nil, zero value otherwise.

### GetDeleteProtectionOk

`func (o *CreateAuthMethodOAuth2) GetDeleteProtectionOk() (*string, bool)`
...
`func (o *CreateAuthMethodOAuth2) SetDeleteProtection(v string)`

SetDeleteProtection sets DeleteProtection field to given value.

### HasDeleteProtection

`func (o *CreateAuthMethodOAuth2) HasDeleteProtection() bool`
...
`func (o *CreateAuthMethodOAuth2) GetExpirationEventIn() []string`

GetExpirationEventIn returns the ExpirationEventIn field if non-nil, zero value otherwise.

### GetExpirationEventInOk

`func (o *CreateAuthMethodOAuth2) GetExpirationEventInOk() (*[]string, bool)`
...
`func (o *CreateAuthMethodOAuth2) SetExpirationEventIn(v []string)`

SetExpirationEventIn sets ExpirationEventIn field to given value.

### HasExpirationEventIn

`func (o *CreateAuthMethodOAuth2) HasExpirationEventIn() bool`
...
`func (o *CreateAuthMethodOAuth2) HasJwksUri() bool`
