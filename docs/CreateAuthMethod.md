...
`func (o *CreateAuthMethod) SetAuditLogsClaims(v []string)`

SetAuditLogsClaims sets AuditLogsClaims field to given value.

### HasAuditLogsClaims

`func (o *CreateAuthMethod) HasAuditLogsClaims() bool`
...
`func (o *CreateAuthMethod) GetDeleteProtection() string`

GetDeleteProtection returns the DeleteProtection field if non-nil, zero value otherwise.

### GetDeleteProtectionOk

`func (o *CreateAuthMethod) GetDeleteProtectionOk() (*string, bool)`
...
`func (o *CreateAuthMethod) SetDeleteProtection(v string)`

SetDeleteProtection sets DeleteProtection field to given value.

### HasDeleteProtection

`func (o *CreateAuthMethod) HasDeleteProtection() bool`
...
`func (o *CreateAuthMethod) SetExpirationEventIn(v []string)`

SetExpirationEventIn sets ExpirationEventIn field to given value.

### HasExpirationEventIn

`func (o *CreateAuthMethod) HasExpirationEventIn() bool`
