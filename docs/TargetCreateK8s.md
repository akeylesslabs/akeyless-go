...
`func (o *TargetCreateK8s) GetDeleteProtection() string`

GetDeleteProtection returns the DeleteProtection field if non-nil, zero value otherwise.

### GetDeleteProtectionOk

`func (o *TargetCreateK8s) GetDeleteProtectionOk() (*string, bool)`
...
`func (o *TargetCreateK8s) SetDeleteProtection(v string)`

SetDeleteProtection sets DeleteProtection field to given value.

### HasDeleteProtection

`func (o *TargetCreateK8s) HasDeleteProtection() bool`
...
`func (o *TargetCreateK8s) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *TargetCreateK8s) GetLockOnReadOk() (*string, bool)`
...
`func (o *TargetCreateK8s) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *TargetCreateK8s) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *TargetCreateK8s) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *TargetCreateK8s) GetLockTtlOk() (*string, bool)`
...
`func (o *TargetCreateK8s) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *TargetCreateK8s) HasLockTtl() bool`
...
`func (o *TargetCreateK8s) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *TargetCreateK8s) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *TargetCreateK8s) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *TargetCreateK8s) HasRotateOnUnlock() bool`
