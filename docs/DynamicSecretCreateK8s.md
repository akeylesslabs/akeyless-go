...
`func (o *DynamicSecretCreateK8s) GetAraEnabled() bool`

GetAraEnabled returns the AraEnabled field if non-nil, zero value otherwise.

### GetAraEnabledOk

`func (o *DynamicSecretCreateK8s) GetAraEnabledOk() (*bool, bool)`
...
`func (o *DynamicSecretCreateK8s) SetAraEnabled(v bool)`

SetAraEnabled sets AraEnabled field to given value.

### HasAraEnabled

`func (o *DynamicSecretCreateK8s) HasAraEnabled() bool`

HasAraEnabled returns a boolean if a field has been set.

### GetCustomUsernameTemplate

`func (o *DynamicSecretCreateK8s) GetCustomUsernameTemplate() string`
...
`func (o *DynamicSecretCreateK8s) GetCustomUsernameTemplateOk() (*string, bool)`
...
`func (o *DynamicSecretCreateK8s) SetCustomUsernameTemplate(v string)`

SetCustomUsernameTemplate sets CustomUsernameTemplate field to given value.

### HasCustomUsernameTemplate

`func (o *DynamicSecretCreateK8s) HasCustomUsernameTemplate() bool`
...
`func (o *DynamicSecretCreateK8s) GetEnableAgenticRuntimeAuthority() bool`
...
`func (o *DynamicSecretCreateK8s) GetEnableAgenticRuntimeAuthorityOk() (*bool, bool)`
...
`func (o *DynamicSecretCreateK8s) SetEnableAiQuorum(v bool)`

SetEnableAiQuorum sets EnableAiQuorum field to given value.

### HasEnableAiQuorum

`func (o *DynamicSecretCreateK8s) HasEnableAiQuorum() bool`

HasEnableAiQuorum returns a boolean if a field has been set.

### GetInputRule

`func (o *DynamicSecretCreateK8s) GetInputRule() []string`

GetInputRule returns the InputRule field if non-nil, zero value otherwise.

### GetInputRuleOk

`func (o *DynamicSecretCreateK8s) GetInputRuleOk() (*[]string, bool)`
...
`func (o *DynamicSecretCreateK8s) SetInputRule(v []string)`

SetInputRule sets InputRule field to given value.

### HasInputRule

`func (o *DynamicSecretCreateK8s) HasInputRule() bool`

HasInputRule returns a boolean if a field has been set.

### GetItemCustomFields

`func (o *DynamicSecretCreateK8s) GetItemCustomFields() map[string]string`

GetItemCustomFields returns the ItemCustomFields field if non-nil, zero value otherwise.

### GetItemCustomFieldsOk

`func (o *DynamicSecretCreateK8s) GetItemCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *DynamicSecretCreateK8s) SetItemCustomFields(v map[string]string)`

SetItemCustomFields sets ItemCustomFields field to given value.

### HasItemCustomFields

`func (o *DynamicSecretCreateK8s) HasItemCustomFields() bool`
...
`func (o *DynamicSecretCreateK8s) GetK8sRolebindingYamlData() string`
...
`func (o *DynamicSecretCreateK8s) GetK8sRolebindingYamlDataOk() (*string, bool)`
...
`func (o *DynamicSecretCreateK8s) SetK8sRolebindingYamlData(v string)`

SetK8sRolebindingYamlData sets K8sRolebindingYamlData field to given value.

### HasK8sRolebindingYamlData

`func (o *DynamicSecretCreateK8s) HasK8sRolebindingYamlData() bool`
...
`func (o *DynamicSecretCreateK8s) GetOutputRule() []string`

GetOutputRule returns the OutputRule field if non-nil, zero value otherwise.

### GetOutputRuleOk

`func (o *DynamicSecretCreateK8s) GetOutputRuleOk() (*[]string, bool)`
...
`func (o *DynamicSecretCreateK8s) SetOutputRule(v []string)`

SetOutputRule sets OutputRule field to given value.

### HasOutputRule

`func (o *DynamicSecretCreateK8s) HasOutputRule() bool`
...
`func (o *DynamicSecretCreateK8s) GetSkipDryRun() string`

GetSkipDryRun returns the SkipDryRun field if non-nil, zero value otherwise.

### GetSkipDryRunOk

`func (o *DynamicSecretCreateK8s) GetSkipDryRunOk() (*string, bool)`
...
`func (o *DynamicSecretCreateK8s) SetSkipDryRun(v string)`

SetSkipDryRun sets SkipDryRun field to given value.

### HasSkipDryRun

`func (o *DynamicSecretCreateK8s) HasSkipDryRun() bool`
