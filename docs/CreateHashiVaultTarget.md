...
`func (o *CreateHashiVaultTarget) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *CreateHashiVaultTarget) GetLockOnReadOk() (*string, bool)`
...
`func (o *CreateHashiVaultTarget) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *CreateHashiVaultTarget) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *CreateHashiVaultTarget) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *CreateHashiVaultTarget) GetLockTtlOk() (*string, bool)`
...
`func (o *CreateHashiVaultTarget) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *CreateHashiVaultTarget) HasLockTtl() bool`
...
`func (o *CreateHashiVaultTarget) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *CreateHashiVaultTarget) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *CreateHashiVaultTarget) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *CreateHashiVaultTarget) HasRotateOnUnlock() bool`
