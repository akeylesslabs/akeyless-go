...
**RsaKeyFilePath** | Pointer to **string** | RSA private key file path | [optional] 
...
GetRsaKeyFilePath returns the RsaKeyFilePath field if non-nil, zero value otherwise.

### GetRsaKeyFilePathOk

`func (o *UploadRSA) GetRsaKeyFilePathOk() (*string, bool)`

GetRsaKeyFilePathOk returns a tuple with the RsaKeyFilePath field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetRsaKeyFilePath sets RsaKeyFilePath field to given value.
