...
`func (o *CreateZeroSSLTarget) GetLockOnRead() string`

GetLockOnRead returns the LockOnRead field if non-nil, zero value otherwise.

### GetLockOnReadOk

`func (o *CreateZeroSSLTarget) GetLockOnReadOk() (*string, bool)`
...
`func (o *CreateZeroSSLTarget) SetLockOnRead(v string)`

SetLockOnRead sets LockOnRead field to given value.

### HasLockOnRead

`func (o *CreateZeroSSLTarget) HasLockOnRead() bool`

HasLockOnRead returns a boolean if a field has been set.

### GetLockTtl

`func (o *CreateZeroSSLTarget) GetLockTtl() string`

GetLockTtl returns the LockTtl field if non-nil, zero value otherwise.

### GetLockTtlOk

`func (o *CreateZeroSSLTarget) GetLockTtlOk() (*string, bool)`
...
`func (o *CreateZeroSSLTarget) SetLockTtl(v string)`

SetLockTtl sets LockTtl field to given value.

### HasLockTtl

`func (o *CreateZeroSSLTarget) HasLockTtl() bool`
...
`func (o *CreateZeroSSLTarget) GetRotateOnUnlock() string`

GetRotateOnUnlock returns the RotateOnUnlock field if non-nil, zero value otherwise.

### GetRotateOnUnlockOk

`func (o *CreateZeroSSLTarget) GetRotateOnUnlockOk() (*string, bool)`
...
`func (o *CreateZeroSSLTarget) SetRotateOnUnlock(v string)`

SetRotateOnUnlock sets RotateOnUnlock field to given value.

### HasRotateOnUnlock

`func (o *CreateZeroSSLTarget) HasRotateOnUnlock() bool`
