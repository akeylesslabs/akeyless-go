...
// checks if the GatewayCreateProducerOracleDb type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GatewayCreateProducerOracleDb{}
...
type _GatewayCreateProducerOracleDb GatewayCreateProducerOracleDb
...
func (o GatewayCreateProducerOracleDb) ToMap() (map[string]interface{}, error) {
...
func (o *GatewayCreateProducerOracleDb) UnmarshalJSON(data []byte) (err error) {
	...
	varGatewayCreateProducerOracleDb := _GatewayCreateProducerOracleDb{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGatewayCreateProducerOracleDb)

	if err != nil {
		return err
	}

	*o = GatewayCreateProducerOracleDb(varGatewayCreateProducerOracleDb)
