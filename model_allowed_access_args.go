...
// checks if the AllowedAccessArgs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllowedAccessArgs{}
...
func (o AllowedAccessArgs) ToMap() (map[string]interface{}, error) {
