...
// checks if the CreateDBTarget type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateDBTarget{}
...
type _CreateDBTarget CreateDBTarget
...
func (o CreateDBTarget) ToMap() (map[string]interface{}, error) {
...
func (o *CreateDBTarget) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateDBTarget := _CreateDBTarget{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateDBTarget)

	if err != nil {
		return err
	}

	*o = CreateDBTarget(varCreateDBTarget)
