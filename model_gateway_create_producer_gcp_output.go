...
// checks if the GatewayCreateProducerGcpOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GatewayCreateProducerGcpOutput{}
...
func (o GatewayCreateProducerGcpOutput) ToMap() (map[string]interface{}, error) {
