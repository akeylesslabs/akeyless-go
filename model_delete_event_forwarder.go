...
// checks if the DeleteEventForwarder type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteEventForwarder{}
...
type _DeleteEventForwarder DeleteEventForwarder
...
func (o DeleteEventForwarder) MarshalJSON() ([]byte, error) {
...
func (o DeleteEventForwarder) ToMap() (map[string]interface{}, error) {
...
func (o *DeleteEventForwarder) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteEventForwarder := _DeleteEventForwarder{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteEventForwarder)

	if err != nil {
		return err
	}

	*o = DeleteEventForwarder(varDeleteEventForwarder)

	return err
}

type NullableDeleteEventForwarder struct {
	value *DeleteEventForwarder
	isSet bool
}

func (v NullableDeleteEventForwarder) Get() *DeleteEventForwarder {
	return v.value
}

func (v *NullableDeleteEventForwarder) Set(val *DeleteEventForwarder) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteEventForwarder) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteEventForwarder) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteEventForwarder(val *DeleteEventForwarder) *NullableDeleteEventForwarder {
	return &NullableDeleteEventForwarder{value: val, isSet: true}
}

func (v NullableDeleteEventForwarder) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteEventForwarder) UnmarshalJSON(src []byte) error {
	v.isSet = true
