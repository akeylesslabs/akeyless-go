...
// checks if the TargetCreateWeb type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TargetCreateWeb{}

// TargetCreateWeb targetCreateWeb is a command that creates a new web target
type TargetCreateWeb struct {
...
type _TargetCreateWeb TargetCreateWeb
...
func (o TargetCreateWeb) MarshalJSON() ([]byte, error) {
...
func (o TargetCreateWeb) ToMap() (map[string]interface{}, error) {
...
func (o *TargetCreateWeb) UnmarshalJSON(data []byte) (err error) {
	...
	varTargetCreateWeb := _TargetCreateWeb{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTargetCreateWeb)

	if err != nil {
		return err
	}

	*o = TargetCreateWeb(varTargetCreateWeb)

	return err
}

type NullableTargetCreateWeb struct {
	value *TargetCreateWeb
	isSet bool
}

func (v NullableTargetCreateWeb) Get() *TargetCreateWeb {
	return v.value
}

func (v *NullableTargetCreateWeb) Set(val *TargetCreateWeb) {
	v.value = val
	v.isSet = true
}

func (v NullableTargetCreateWeb) IsSet() bool {
	return v.isSet
}

func (v *NullableTargetCreateWeb) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTargetCreateWeb(val *TargetCreateWeb) *NullableTargetCreateWeb {
	return &NullableTargetCreateWeb{value: val, isSet: true}
}

func (v NullableTargetCreateWeb) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTargetCreateWeb) UnmarshalJSON(src []byte) error {
	v.isSet = true
