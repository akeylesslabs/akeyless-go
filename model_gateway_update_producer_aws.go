...
// checks if the GatewayUpdateProducerAws type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GatewayUpdateProducerAws{}
...
type _GatewayUpdateProducerAws GatewayUpdateProducerAws
...
func (o GatewayUpdateProducerAws) ToMap() (map[string]interface{}, error) {
...
func (o *GatewayUpdateProducerAws) UnmarshalJSON(data []byte) (err error) {
	...
	varGatewayUpdateProducerAws := _GatewayUpdateProducerAws{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGatewayUpdateProducerAws)

	if err != nil {
		return err
	}

	*o = GatewayUpdateProducerAws(varGatewayUpdateProducerAws)
