...
// CreateAuthMethod createAuthMethod is a command that creates a new auth method. [Deprecated: Use auth-method-create-api-key command]
...
type _CreateAuthMethod CreateAuthMethod
...
func (o *CreateAuthMethod) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateAuthMethod := _CreateAuthMethod{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateAuthMethod)

	if err != nil {
		return err
	}

	*o = CreateAuthMethod(varCreateAuthMethod)
