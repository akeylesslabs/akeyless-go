...
// checks if the UpdateGlobalSignAtlasTarget type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateGlobalSignAtlasTarget{}
...
type _UpdateGlobalSignAtlasTarget UpdateGlobalSignAtlasTarget
...
func (o UpdateGlobalSignAtlasTarget) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateGlobalSignAtlasTarget) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateGlobalSignAtlasTarget := _UpdateGlobalSignAtlasTarget{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateGlobalSignAtlasTarget)

	if err != nil {
		return err
	}

	*o = UpdateGlobalSignAtlasTarget(varUpdateGlobalSignAtlasTarget)
