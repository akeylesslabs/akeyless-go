...
// DsCreateK8s dsCreateK8s is a command that creates k8s dynamic secret
type DsCreateK8s struct {
...
func (o DsCreateK8s) MarshalJSON() ([]byte, error) {
...
type NullableDsCreateK8s struct {
	value *DsCreateK8s
	isSet bool
}

func (v NullableDsCreateK8s) Get() *DsCreateK8s {
	return v.value
}

func (v *NullableDsCreateK8s) Set(val *DsCreateK8s) {
	v.value = val
	v.isSet = true
}

func (v NullableDsCreateK8s) IsSet() bool {
	return v.isSet
}

func (v *NullableDsCreateK8s) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDsCreateK8s(val *DsCreateK8s) *NullableDsCreateK8s {
	return &NullableDsCreateK8s{value: val, isSet: true}
}

func (v NullableDsCreateK8s) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDsCreateK8s) UnmarshalJSON(src []byte) error {
	v.isSet = true
