...
// checks if the AuthMethodUpdateK8s type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthMethodUpdateK8s{}
...
type _AuthMethodUpdateK8s AuthMethodUpdateK8s
...
func (o AuthMethodUpdateK8s) ToMap() (map[string]interface{}, error) {
...
func (o *AuthMethodUpdateK8s) UnmarshalJSON(data []byte) (err error) {
	...
	varAuthMethodUpdateK8s := _AuthMethodUpdateK8s{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAuthMethodUpdateK8s)

	if err != nil {
		return err
	}

	*o = AuthMethodUpdateK8s(varAuthMethodUpdateK8s)
