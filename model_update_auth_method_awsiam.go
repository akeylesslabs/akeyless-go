...
// checks if the UpdateAuthMethodAWSIAM type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateAuthMethodAWSIAM{}

// UpdateAuthMethodAWSIAM updateAuthMethodAWSIAM is a command that updates a new Auth Method that will be able to authenticate using AWS IAM credentials. [Deprecated: Use auth-method-update-aws-iam command]
...
type _UpdateAuthMethodAWSIAM UpdateAuthMethodAWSIAM
...
func (o UpdateAuthMethodAWSIAM) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateAuthMethodAWSIAM) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateAuthMethodAWSIAM := _UpdateAuthMethodAWSIAM{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateAuthMethodAWSIAM)

	if err != nil {
		return err
	}

	*o = UpdateAuthMethodAWSIAM(varUpdateAuthMethodAWSIAM)
