...
type _GatewayCreateProducerRdp GatewayCreateProducerRdp
...
func (o *GatewayCreateProducerRdp) UnmarshalJSON(data []byte) (err error) {
	...
	varGatewayCreateProducerRdp := _GatewayCreateProducerRdp{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGatewayCreateProducerRdp)

	if err != nil {
		return err
	}

	*o = GatewayCreateProducerRdp(varGatewayCreateProducerRdp)
