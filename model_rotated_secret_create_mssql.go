...
// checks if the RotatedSecretCreateMssql type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RotatedSecretCreateMssql{}
...
type _RotatedSecretCreateMssql RotatedSecretCreateMssql
...
func (o RotatedSecretCreateMssql) ToMap() (map[string]interface{}, error) {
...
func (o *RotatedSecretCreateMssql) UnmarshalJSON(data []byte) (err error) {
	...
	varRotatedSecretCreateMssql := _RotatedSecretCreateMssql{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRotatedSecretCreateMssql)

	if err != nil {
		return err
	}

	*o = RotatedSecretCreateMssql(varRotatedSecretCreateMssql)
