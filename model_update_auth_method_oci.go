...
// checks if the UpdateAuthMethodOCI type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateAuthMethodOCI{}

// UpdateAuthMethodOCI updateAuthMethodOCI is a command that updates an auth method that will be used in the account using OCI principle and groups. [Deprecated: Use auth-method-update-oci command]
...
type _UpdateAuthMethodOCI UpdateAuthMethodOCI
...
func (o UpdateAuthMethodOCI) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateAuthMethodOCI) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateAuthMethodOCI := _UpdateAuthMethodOCI{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateAuthMethodOCI)

	if err != nil {
		return err
	}

	*o = UpdateAuthMethodOCI(varUpdateAuthMethodOCI)
