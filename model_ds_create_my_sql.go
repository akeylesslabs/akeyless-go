...
// DsCreateMySql dsCreateMySql is a command that creates mysql dynamic secret
type DsCreateMySql struct {
...
func (o DsCreateMySql) MarshalJSON() ([]byte, error) {
...
type NullableDsCreateMySql struct {
	value *DsCreateMySql
	isSet bool
}

func (v NullableDsCreateMySql) Get() *DsCreateMySql {
	return v.value
}

func (v *NullableDsCreateMySql) Set(val *DsCreateMySql) {
	v.value = val
	v.isSet = true
}

func (v NullableDsCreateMySql) IsSet() bool {
	return v.isSet
}

func (v *NullableDsCreateMySql) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDsCreateMySql(val *DsCreateMySql) *NullableDsCreateMySql {
	return &NullableDsCreateMySql{value: val, isSet: true}
}

func (v NullableDsCreateMySql) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDsCreateMySql) UnmarshalJSON(src []byte) error {
	v.isSet = true
