...
// checks if the DynamicSecretCreateK8s type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DynamicSecretCreateK8s{}
...
type _DynamicSecretCreateK8s DynamicSecretCreateK8s
...
func (o DynamicSecretCreateK8s) MarshalJSON() ([]byte, error) {
...
func (o DynamicSecretCreateK8s) ToMap() (map[string]interface{}, error) {
...
func (o *DynamicSecretCreateK8s) UnmarshalJSON(data []byte) (err error) {
	...
	varDynamicSecretCreateK8s := _DynamicSecretCreateK8s{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDynamicSecretCreateK8s)

	if err != nil {
		return err
	}

	*o = DynamicSecretCreateK8s(varDynamicSecretCreateK8s)

	return err
}

type NullableDynamicSecretCreateK8s struct {
	value *DynamicSecretCreateK8s
	isSet bool
}

func (v NullableDynamicSecretCreateK8s) Get() *DynamicSecretCreateK8s {
	return v.value
}

func (v *NullableDynamicSecretCreateK8s) Set(val *DynamicSecretCreateK8s) {
	v.value = val
	v.isSet = true
}

func (v NullableDynamicSecretCreateK8s) IsSet() bool {
	return v.isSet
}

func (v *NullableDynamicSecretCreateK8s) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDynamicSecretCreateK8s(val *DynamicSecretCreateK8s) *NullableDynamicSecretCreateK8s {
	return &NullableDynamicSecretCreateK8s{value: val, isSet: true}
}

func (v NullableDynamicSecretCreateK8s) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDynamicSecretCreateK8s) UnmarshalJSON(src []byte) error {
	v.isSet = true
