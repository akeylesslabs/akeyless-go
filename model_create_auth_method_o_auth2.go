...
// checks if the CreateAuthMethodOAuth2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAuthMethodOAuth2{}
...
type _CreateAuthMethodOAuth2 CreateAuthMethodOAuth2
...
func (o CreateAuthMethodOAuth2) ToMap() (map[string]interface{}, error) {
...
func (o *CreateAuthMethodOAuth2) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateAuthMethodOAuth2 := _CreateAuthMethodOAuth2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateAuthMethodOAuth2)

	if err != nil {
		return err
	}

	*o = CreateAuthMethodOAuth2(varCreateAuthMethodOAuth2)
