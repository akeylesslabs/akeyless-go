...
// checks if the GatewayCreateProducerCertificateAutomation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GatewayCreateProducerCertificateAutomation{}
...
func (o GatewayCreateProducerCertificateAutomation) ToMap() (map[string]interface{}, error) {
