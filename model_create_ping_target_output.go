...
// checks if the CreatePingTargetOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreatePingTargetOutput{}
...
func (o CreatePingTargetOutput) ToMap() (map[string]interface{}, error) {
