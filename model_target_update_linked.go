...
// checks if the TargetUpdateLinked type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TargetUpdateLinked{}
...
type _TargetUpdateLinked TargetUpdateLinked
...
func (o TargetUpdateLinked) ToMap() (map[string]interface{}, error) {
...
func (o *TargetUpdateLinked) UnmarshalJSON(data []byte) (err error) {
	...
	varTargetUpdateLinked := _TargetUpdateLinked{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTargetUpdateLinked)

	if err != nil {
		return err
	}

	*o = TargetUpdateLinked(varTargetUpdateLinked)
