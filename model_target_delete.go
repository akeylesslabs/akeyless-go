...
// checks if the TargetDelete type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TargetDelete{}
...
type _TargetDelete TargetDelete
...
func (o TargetDelete) ToMap() (map[string]interface{}, error) {
...
func (o *TargetDelete) UnmarshalJSON(data []byte) (err error) {
	...
	varTargetDelete := _TargetDelete{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTargetDelete)

	if err != nil {
		return err
	}

	*o = TargetDelete(varTargetDelete)
