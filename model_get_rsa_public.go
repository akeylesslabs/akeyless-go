...
// checks if the GetRSAPublic type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRSAPublic{}
...
type _GetRSAPublic GetRSAPublic
...
func (o GetRSAPublic) ToMap() (map[string]interface{}, error) {
...
func (o *GetRSAPublic) UnmarshalJSON(data []byte) (err error) {
	...
	varGetRSAPublic := _GetRSAPublic{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetRSAPublic)

	if err != nil {
		return err
	}

	*o = GetRSAPublic(varGetRSAPublic)
