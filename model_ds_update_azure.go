...
// DsUpdateAzure dsUpdateAzure is a command that updates azure dynamic secret
type DsUpdateAzure struct {
	// Azure App Object Id
...
func (o DsUpdateAzure) MarshalJSON() ([]byte, error) {
...
type NullableDsUpdateAzure struct {
	value *DsUpdateAzure
	isSet bool
}

func (v NullableDsUpdateAzure) Get() *DsUpdateAzure {
	return v.value
}

func (v *NullableDsUpdateAzure) Set(val *DsUpdateAzure) {
	v.value = val
	v.isSet = true
}

func (v NullableDsUpdateAzure) IsSet() bool {
	return v.isSet
}

func (v *NullableDsUpdateAzure) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDsUpdateAzure(val *DsUpdateAzure) *NullableDsUpdateAzure {
	return &NullableDsUpdateAzure{value: val, isSet: true}
}

func (v NullableDsUpdateAzure) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDsUpdateAzure) UnmarshalJSON(src []byte) error {
	v.isSet = true
