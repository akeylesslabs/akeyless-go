...
type _GatewayCreateProducerMongo GatewayCreateProducerMongo
...
func (o *GatewayCreateProducerMongo) UnmarshalJSON(data []byte) (err error) {
	...
	varGatewayCreateProducerMongo := _GatewayCreateProducerMongo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGatewayCreateProducerMongo)

	if err != nil {
		return err
	}

	*o = GatewayCreateProducerMongo(varGatewayCreateProducerMongo)
