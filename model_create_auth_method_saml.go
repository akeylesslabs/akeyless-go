...
// checks if the CreateAuthMethodSAML type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAuthMethodSAML{}

// CreateAuthMethodSAML createAuthMethodSAML is a command that creates a new auth method that will be available to authenticate using SAML. [Deprecated: Use auth-method-create-saml command]
...
func (o CreateAuthMethodSAML) ToMap() (map[string]interface{}, error) {
...
func (o *CreateAuthMethodSAML) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateAuthMethodSAML := _CreateAuthMethodSAML{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateAuthMethodSAML)

	if err != nil {
		return err
	}

	*o = CreateAuthMethodSAML(varCreateAuthMethodSAML)
