...
func (o *CreateSecret) GetPasswordManagerCustomField() map[string]string {
	if o == nil || IsNil(o.PasswordManagerCustomField) {
...
func (o *CreateSecret) GetPasswordManagerInjectUrl() []string {
	if o == nil || IsNil(o.PasswordManagerInjectUrl) {
		var ret []string
		return ret
	}
...
func (o *CreateSecret) GetPasswordManagerPassword() string {
	if o == nil || IsNil(o.PasswordManagerPassword) {
		var ret string
		return ret
	}
...
func (o *CreateSecret) GetPasswordManagerUsername() string {
	if o == nil || IsNil(o.PasswordManagerUsername) {
		var ret string
		return ret
	}
