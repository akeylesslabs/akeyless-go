...
// checks if the TargetUpdateLdap type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TargetUpdateLdap{}

// TargetUpdateLdap targetUpdateLdap is a command that updates an existing ldap target
type TargetUpdateLdap struct {
	// Bind DN
...
type _TargetUpdateLdap TargetUpdateLdap
...
func (o TargetUpdateLdap) MarshalJSON() ([]byte, error) {
...
func (o TargetUpdateLdap) ToMap() (map[string]interface{}, error) {
...
func (o *TargetUpdateLdap) UnmarshalJSON(data []byte) (err error) {
	...
	varTargetUpdateLdap := _TargetUpdateLdap{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTargetUpdateLdap)

	if err != nil {
		return err
	}

	*o = TargetUpdateLdap(varTargetUpdateLdap)

	return err
}

type NullableTargetUpdateLdap struct {
	value *TargetUpdateLdap
	isSet bool
}

func (v NullableTargetUpdateLdap) Get() *TargetUpdateLdap {
	return v.value
}

func (v *NullableTargetUpdateLdap) Set(val *TargetUpdateLdap) {
	v.value = val
	v.isSet = true
}

func (v NullableTargetUpdateLdap) IsSet() bool {
	return v.isSet
}

func (v *NullableTargetUpdateLdap) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTargetUpdateLdap(val *TargetUpdateLdap) *NullableTargetUpdateLdap {
	return &NullableTargetUpdateLdap{value: val, isSet: true}
}

func (v NullableTargetUpdateLdap) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTargetUpdateLdap) UnmarshalJSON(src []byte) error {
	v.isSet = true
