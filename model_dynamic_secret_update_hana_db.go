...
// checks if the DynamicSecretUpdateHanaDb type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DynamicSecretUpdateHanaDb{}
...
type _DynamicSecretUpdateHanaDb DynamicSecretUpdateHanaDb
...
func (o *DynamicSecretUpdateHanaDb) UnmarshalJSON(data []byte) (err error) {
	...
	varDynamicSecretUpdateHanaDb := _DynamicSecretUpdateHanaDb{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDynamicSecretUpdateHanaDb)

	if err != nil {
		return err
	}

	*o = DynamicSecretUpdateHanaDb(varDynamicSecretUpdateHanaDb)
