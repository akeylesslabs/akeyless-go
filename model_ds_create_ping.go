...
// DsCreatePing dsCreatePing is a command that creates ping dynamic secret
type DsCreatePing struct {
...
func (o DsCreatePing) MarshalJSON() ([]byte, error) {
...
type NullableDsCreatePing struct {
	value *DsCreatePing
	isSet bool
}

func (v NullableDsCreatePing) Get() *DsCreatePing {
	return v.value
}

func (v *NullableDsCreatePing) Set(val *DsCreatePing) {
	v.value = val
	v.isSet = true
}

func (v NullableDsCreatePing) IsSet() bool {
	return v.isSet
}

func (v *NullableDsCreatePing) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDsCreatePing(val *DsCreatePing) *NullableDsCreatePing {
	return &NullableDsCreatePing{value: val, isSet: true}
}

func (v NullableDsCreatePing) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDsCreatePing) UnmarshalJSON(src []byte) error {
	v.isSet = true
