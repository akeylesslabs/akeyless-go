...
type _GatewayUpdateProducerRabbitMQ GatewayUpdateProducerRabbitMQ
...
func (o *GatewayUpdateProducerRabbitMQ) UnmarshalJSON(data []byte) (err error) {
	...
	varGatewayUpdateProducerRabbitMQ := _GatewayUpdateProducerRabbitMQ{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGatewayUpdateProducerRabbitMQ)

	if err != nil {
		return err
	}

	*o = GatewayUpdateProducerRabbitMQ(varGatewayUpdateProducerRabbitMQ)
