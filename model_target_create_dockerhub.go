...
// checks if the TargetCreateDockerhub type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TargetCreateDockerhub{}
...
type _TargetCreateDockerhub TargetCreateDockerhub
...
func (o TargetCreateDockerhub) ToMap() (map[string]interface{}, error) {
...
func (o *TargetCreateDockerhub) UnmarshalJSON(data []byte) (err error) {
	...
	varTargetCreateDockerhub := _TargetCreateDockerhub{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTargetCreateDockerhub)

	if err != nil {
		return err
	}

	*o = TargetCreateDockerhub(varTargetCreateDockerhub)
