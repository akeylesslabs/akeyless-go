...
// DsUpdateAws dsUpdateAws is a command that Updates aws dynamic secret
type DsUpdateAws struct {
...
func (o DsUpdateAws) MarshalJSON() ([]byte, error) {
...
type NullableDsUpdateAws struct {
	value *DsUpdateAws
	isSet bool
}

func (v NullableDsUpdateAws) Get() *DsUpdateAws {
	return v.value
}

func (v *NullableDsUpdateAws) Set(val *DsUpdateAws) {
	v.value = val
	v.isSet = true
}

func (v NullableDsUpdateAws) IsSet() bool {
	return v.isSet
}

func (v *NullableDsUpdateAws) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDsUpdateAws(val *DsUpdateAws) *NullableDsUpdateAws {
	return &NullableDsUpdateAws{value: val, isSet: true}
}

func (v NullableDsUpdateAws) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDsUpdateAws) UnmarshalJSON(src []byte) error {
	v.isSet = true
