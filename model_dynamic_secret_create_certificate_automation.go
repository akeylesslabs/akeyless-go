...
// DynamicSecretCreateCertificateAutomation dynamicSecretCreateCertificateAutomation is a command that creates a Certificate Automation dynamic secret to dynamically create certificates generated by Venafi or have Akeyless generated certificates using PKI be monitored by Venafi
type DynamicSecretCreateCertificateAutomation struct {
...
func NewDynamicSecretCreateCertificateAutomation(name string, ) *DynamicSecretCreateCertificateAutomation {
	this := DynamicSecretCreateCertificateAutomation{}
...
func (o DynamicSecretCreateCertificateAutomation) MarshalJSON() ([]byte, error) {
...
type NullableDynamicSecretCreateCertificateAutomation struct {
	value *DynamicSecretCreateCertificateAutomation
	isSet bool
}

func (v NullableDynamicSecretCreateCertificateAutomation) Get() *DynamicSecretCreateCertificateAutomation {
	return v.value
}

func (v *NullableDynamicSecretCreateCertificateAutomation) Set(val *DynamicSecretCreateCertificateAutomation) {
	v.value = val
	v.isSet = true
}

func (v NullableDynamicSecretCreateCertificateAutomation) IsSet() bool {
	return v.isSet
}

func (v *NullableDynamicSecretCreateCertificateAutomation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDynamicSecretCreateCertificateAutomation(val *DynamicSecretCreateCertificateAutomation) *NullableDynamicSecretCreateCertificateAutomation {
	return &NullableDynamicSecretCreateCertificateAutomation{value: val, isSet: true}
}

func (v NullableDynamicSecretCreateCertificateAutomation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDynamicSecretCreateCertificateAutomation) UnmarshalJSON(src []byte) error {
	v.isSet = true
