...
// checks if the CreateSSHTarget type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateSSHTarget{}
...
type _CreateSSHTarget CreateSSHTarget
...
func (o CreateSSHTarget) ToMap() (map[string]interface{}, error) {
...
func (o *CreateSSHTarget) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateSSHTarget := _CreateSSHTarget{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateSSHTarget)

	if err != nil {
		return err
	}

	*o = CreateSSHTarget(varCreateSSHTarget)
