...
// checks if the UpdateGcpTargetOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateGcpTargetOutput{}
...
func (o UpdateGcpTargetOutput) ToMap() (map[string]interface{}, error) {
