...
// checks if the GatewayDownloadCustomerFragments type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GatewayDownloadCustomerFragments{}
...
func (o GatewayDownloadCustomerFragments) ToMap() (map[string]interface{}, error) {
