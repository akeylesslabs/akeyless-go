...
// checks if the CreateAuthMethodHuawei type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAuthMethodHuawei{}
...
type _CreateAuthMethodHuawei CreateAuthMethodHuawei
...
func (o *CreateAuthMethodHuawei) GetBoundDomainId() []string {
	if o == nil || IsNil(o.BoundDomainId) {
		var ret []string
		return ret
	}
...
func (o *CreateAuthMethodHuawei) GetBoundDomainName() []string {
	if o == nil || IsNil(o.BoundDomainName) {
		var ret []string
		return ret
	}
...
func (o *CreateAuthMethodHuawei) GetBoundTenantName() []string {
	if o == nil || IsNil(o.BoundTenantName) {
		var ret []string
		return ret
	}
...
func (o CreateAuthMethodHuawei) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.BoundDomainId) {
		toSerialize["bound-domain-id"] = o.BoundDomainId
	}
	if !IsNil(o.BoundDomainName) {
...
func (o *CreateAuthMethodHuawei) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateAuthMethodHuawei := _CreateAuthMethodHuawei{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateAuthMethodHuawei)

	if err != nil {
		return err
	}

	*o = CreateAuthMethodHuawei(varCreateAuthMethodHuawei)
