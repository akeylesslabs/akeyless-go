...
// checks if the DynamicSecretUpdateEks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DynamicSecretUpdateEks{}
...
type _DynamicSecretUpdateEks DynamicSecretUpdateEks
...
func (o DynamicSecretUpdateEks) ToMap() (map[string]interface{}, error) {
...
func (o *DynamicSecretUpdateEks) UnmarshalJSON(data []byte) (err error) {
	...
	varDynamicSecretUpdateEks := _DynamicSecretUpdateEks{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDynamicSecretUpdateEks)

	if err != nil {
		return err
	}

	*o = DynamicSecretUpdateEks(varDynamicSecretUpdateEks)
