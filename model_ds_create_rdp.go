...
// DsCreateRdp dsCreateRdp is a command that creates rdp dynamic secret
type DsCreateRdp struct {
...
func (o DsCreateRdp) MarshalJSON() ([]byte, error) {
...
type NullableDsCreateRdp struct {
	value *DsCreateRdp
	isSet bool
}

func (v NullableDsCreateRdp) Get() *DsCreateRdp {
	return v.value
}

func (v *NullableDsCreateRdp) Set(val *DsCreateRdp) {
	v.value = val
	v.isSet = true
}

func (v NullableDsCreateRdp) IsSet() bool {
	return v.isSet
}

func (v *NullableDsCreateRdp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDsCreateRdp(val *DsCreateRdp) *NullableDsCreateRdp {
	return &NullableDsCreateRdp{value: val, isSet: true}
}

func (v NullableDsCreateRdp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDsCreateRdp) UnmarshalJSON(src []byte) error {
	v.isSet = true
