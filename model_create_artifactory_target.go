...
type _CreateArtifactoryTarget CreateArtifactoryTarget
...
func (o *CreateArtifactoryTarget) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateArtifactoryTarget := _CreateArtifactoryTarget{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateArtifactoryTarget)

	if err != nil {
		return err
	}

	*o = CreateArtifactoryTarget(varCreateArtifactoryTarget)
