...
// checks if the TargetUpdateF5BigIp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TargetUpdateF5BigIp{}

// TargetUpdateF5BigIp targetUpdateF5BigIp is a command that updates an existing f5-big-ip target
type TargetUpdateF5BigIp struct {
...
type _TargetUpdateF5BigIp TargetUpdateF5BigIp
...
func (o TargetUpdateF5BigIp) MarshalJSON() ([]byte, error) {
...
func (o TargetUpdateF5BigIp) ToMap() (map[string]interface{}, error) {
...
func (o *TargetUpdateF5BigIp) UnmarshalJSON(data []byte) (err error) {
	...
	varTargetUpdateF5BigIp := _TargetUpdateF5BigIp{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTargetUpdateF5BigIp)

	if err != nil {
		return err
	}

	*o = TargetUpdateF5BigIp(varTargetUpdateF5BigIp)

	return err
}

type NullableTargetUpdateF5BigIp struct {
	value *TargetUpdateF5BigIp
	isSet bool
}

func (v NullableTargetUpdateF5BigIp) Get() *TargetUpdateF5BigIp {
	return v.value
}

func (v *NullableTargetUpdateF5BigIp) Set(val *TargetUpdateF5BigIp) {
	v.value = val
	v.isSet = true
}

func (v NullableTargetUpdateF5BigIp) IsSet() bool {
	return v.isSet
}

func (v *NullableTargetUpdateF5BigIp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTargetUpdateF5BigIp(val *TargetUpdateF5BigIp) *NullableTargetUpdateF5BigIp {
	return &NullableTargetUpdateF5BigIp{value: val, isSet: true}
}

func (v NullableTargetUpdateF5BigIp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTargetUpdateF5BigIp) UnmarshalJSON(src []byte) error {
	v.isSet = true
