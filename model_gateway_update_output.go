...
// checks if the GatewayUpdateOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GatewayUpdateOutput{}
...
func (o GatewayUpdateOutput) ToMap() (map[string]interface{}, error) {
