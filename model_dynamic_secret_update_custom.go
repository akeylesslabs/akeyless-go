...
// checks if the DynamicSecretUpdateCustom type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DynamicSecretUpdateCustom{}
...
type _DynamicSecretUpdateCustom DynamicSecretUpdateCustom
...
func (o DynamicSecretUpdateCustom) ToMap() (map[string]interface{}, error) {
...
func (o *DynamicSecretUpdateCustom) UnmarshalJSON(data []byte) (err error) {
	...
	varDynamicSecretUpdateCustom := _DynamicSecretUpdateCustom{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDynamicSecretUpdateCustom)

	if err != nil {
		return err
	}

	*o = DynamicSecretUpdateCustom(varDynamicSecretUpdateCustom)
