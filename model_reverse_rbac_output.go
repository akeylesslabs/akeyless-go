...
// checks if the ReverseRBACOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReverseRBACOutput{}
...
func (o ReverseRBACOutput) ToMap() (map[string]interface{}, error) {
