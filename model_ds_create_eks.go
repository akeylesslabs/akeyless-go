...
// DsCreateEks dsCreateEks is a command that creates eks dynamic secret
type DsCreateEks struct {
...
func (o DsCreateEks) MarshalJSON() ([]byte, error) {
...
type NullableDsCreateEks struct {
	value *DsCreateEks
	isSet bool
}

func (v NullableDsCreateEks) Get() *DsCreateEks {
	return v.value
}

func (v *NullableDsCreateEks) Set(val *DsCreateEks) {
	v.value = val
	v.isSet = true
}

func (v NullableDsCreateEks) IsSet() bool {
	return v.isSet
}

func (v *NullableDsCreateEks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDsCreateEks(val *DsCreateEks) *NullableDsCreateEks {
	return &NullableDsCreateEks{value: val, isSet: true}
}

func (v NullableDsCreateEks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDsCreateEks) UnmarshalJSON(src []byte) error {
	v.isSet = true
