...
// checks if the GatewayUpdateProducerCertificateAutomationOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GatewayUpdateProducerCertificateAutomationOutput{}
...
func (o GatewayUpdateProducerCertificateAutomationOutput) ToMap() (map[string]interface{}, error) {
