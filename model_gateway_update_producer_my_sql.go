...
// checks if the GatewayUpdateProducerMySQL type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GatewayUpdateProducerMySQL{}
...
type _GatewayUpdateProducerMySQL GatewayUpdateProducerMySQL
...
func (o GatewayUpdateProducerMySQL) ToMap() (map[string]interface{}, error) {
...
func (o *GatewayUpdateProducerMySQL) UnmarshalJSON(data []byte) (err error) {
	...
	varGatewayUpdateProducerMySQL := _GatewayUpdateProducerMySQL{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGatewayUpdateProducerMySQL)

	if err != nil {
		return err
	}

	*o = GatewayUpdateProducerMySQL(varGatewayUpdateProducerMySQL)
