...
// checks if the UscUpdateSecretOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UscUpdateSecretOutput{}
...
func (o UscUpdateSecretOutput) ToMap() (map[string]interface{}, error) {
