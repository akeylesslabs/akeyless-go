...
// checks if the DynamicSecretCreateRdp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DynamicSecretCreateRdp{}
...
type _DynamicSecretCreateRdp DynamicSecretCreateRdp
...
func (o DynamicSecretCreateRdp) ToMap() (map[string]interface{}, error) {
...
func (o *DynamicSecretCreateRdp) UnmarshalJSON(data []byte) (err error) {
	...
	varDynamicSecretCreateRdp := _DynamicSecretCreateRdp{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDynamicSecretCreateRdp)

	if err != nil {
		return err
	}

	*o = DynamicSecretCreateRdp(varDynamicSecretCreateRdp)
