...
// checks if the GatewayUpdateProducerNativeK8S type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GatewayUpdateProducerNativeK8S{}
...
type _GatewayUpdateProducerNativeK8S GatewayUpdateProducerNativeK8S
...
func (o GatewayUpdateProducerNativeK8S) ToMap() (map[string]interface{}, error) {
...
func (o *GatewayUpdateProducerNativeK8S) UnmarshalJSON(data []byte) (err error) {
	...
	varGatewayUpdateProducerNativeK8S := _GatewayUpdateProducerNativeK8S{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGatewayUpdateProducerNativeK8S)

	if err != nil {
		return err
	}

	*o = GatewayUpdateProducerNativeK8S(varGatewayUpdateProducerNativeK8S)
