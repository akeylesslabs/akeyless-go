...
// checks if the UpdateArtifactoryTarget type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateArtifactoryTarget{}
...
type _UpdateArtifactoryTarget UpdateArtifactoryTarget
...
func (o UpdateArtifactoryTarget) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateArtifactoryTarget) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateArtifactoryTarget := _UpdateArtifactoryTarget{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateArtifactoryTarget)

	if err != nil {
		return err
	}

	*o = UpdateArtifactoryTarget(varUpdateArtifactoryTarget)
