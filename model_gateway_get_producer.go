...
// checks if the GatewayGetProducer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GatewayGetProducer{}
...
type _GatewayGetProducer GatewayGetProducer
...
func (o GatewayGetProducer) ToMap() (map[string]interface{}, error) {
...
func (o *GatewayGetProducer) UnmarshalJSON(data []byte) (err error) {
	...
	varGatewayGetProducer := _GatewayGetProducer{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGatewayGetProducer)

	if err != nil {
		return err
	}

	*o = GatewayGetProducer(varGatewayGetProducer)
