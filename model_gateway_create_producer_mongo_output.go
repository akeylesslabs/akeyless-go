...
// checks if the GatewayCreateProducerMongoOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GatewayCreateProducerMongoOutput{}
...
func (o GatewayCreateProducerMongoOutput) ToMap() (map[string]interface{}, error) {
