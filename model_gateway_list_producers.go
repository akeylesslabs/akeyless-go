...
// checks if the GatewayListProducers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GatewayListProducers{}
...
func (o GatewayListProducers) ToMap() (map[string]interface{}, error) {
