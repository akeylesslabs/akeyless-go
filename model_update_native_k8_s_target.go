...
type _UpdateNativeK8STarget UpdateNativeK8STarget
...
func (o *UpdateNativeK8STarget) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateNativeK8STarget := _UpdateNativeK8STarget{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateNativeK8STarget)

	if err != nil {
		return err
	}

	*o = UpdateNativeK8STarget(varUpdateNativeK8STarget)
