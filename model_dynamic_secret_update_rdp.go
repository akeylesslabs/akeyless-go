...
// checks if the DynamicSecretUpdateRdp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DynamicSecretUpdateRdp{}
...
type _DynamicSecretUpdateRdp DynamicSecretUpdateRdp
...
func (o DynamicSecretUpdateRdp) ToMap() (map[string]interface{}, error) {
...
func (o *DynamicSecretUpdateRdp) UnmarshalJSON(data []byte) (err error) {
	...
	varDynamicSecretUpdateRdp := _DynamicSecretUpdateRdp{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDynamicSecretUpdateRdp)

	if err != nil {
		return err
	}

	*o = DynamicSecretUpdateRdp(varDynamicSecretUpdateRdp)
