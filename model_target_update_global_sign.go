...
// checks if the TargetUpdateGlobalSign type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TargetUpdateGlobalSign{}
...
type _TargetUpdateGlobalSign TargetUpdateGlobalSign
...
func (o TargetUpdateGlobalSign) ToMap() (map[string]interface{}, error) {
...
func (o *TargetUpdateGlobalSign) UnmarshalJSON(data []byte) (err error) {
	...
	varTargetUpdateGlobalSign := _TargetUpdateGlobalSign{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTargetUpdateGlobalSign)

	if err != nil {
		return err
	}

	*o = TargetUpdateGlobalSign(varTargetUpdateGlobalSign)
