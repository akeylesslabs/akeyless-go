...
// DsUpdateRedis dsUpdateRedis is a command that updates redis dynamic secret
type DsUpdateRedis struct {
...
func (o DsUpdateRedis) MarshalJSON() ([]byte, error) {
...
type NullableDsUpdateRedis struct {
	value *DsUpdateRedis
	isSet bool
}

func (v NullableDsUpdateRedis) Get() *DsUpdateRedis {
	return v.value
}

func (v *NullableDsUpdateRedis) Set(val *DsUpdateRedis) {
	v.value = val
	v.isSet = true
}

func (v NullableDsUpdateRedis) IsSet() bool {
	return v.isSet
}

func (v *NullableDsUpdateRedis) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDsUpdateRedis(val *DsUpdateRedis) *NullableDsUpdateRedis {
	return &NullableDsUpdateRedis{value: val, isSet: true}
}

func (v NullableDsUpdateRedis) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDsUpdateRedis) UnmarshalJSON(src []byte) error {
	v.isSet = true
