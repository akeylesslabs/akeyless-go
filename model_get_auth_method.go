...
// checks if the GetAuthMethod type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAuthMethod{}
...
type _GetAuthMethod GetAuthMethod
...
func (o GetAuthMethod) ToMap() (map[string]interface{}, error) {
...
func (o *GetAuthMethod) UnmarshalJSON(data []byte) (err error) {
	...
	varGetAuthMethod := _GetAuthMethod{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetAuthMethod)

	if err != nil {
		return err
	}

	*o = GetAuthMethod(varGetAuthMethod)
