...
// DsCreateHanaDb dsCreateHanaDb is a command that creates hanadb dynamic secret
type DsCreateHanaDb struct {
...
func (o DsCreateHanaDb) MarshalJSON() ([]byte, error) {
...
type NullableDsCreateHanaDb struct {
	value *DsCreateHanaDb
	isSet bool
}

func (v NullableDsCreateHanaDb) Get() *DsCreateHanaDb {
	return v.value
}

func (v *NullableDsCreateHanaDb) Set(val *DsCreateHanaDb) {
	v.value = val
	v.isSet = true
}

func (v NullableDsCreateHanaDb) IsSet() bool {
	return v.isSet
}

func (v *NullableDsCreateHanaDb) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDsCreateHanaDb(val *DsCreateHanaDb) *NullableDsCreateHanaDb {
	return &NullableDsCreateHanaDb{value: val, isSet: true}
}

func (v NullableDsCreateHanaDb) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDsCreateHanaDb) UnmarshalJSON(src []byte) error {
	v.isSet = true
