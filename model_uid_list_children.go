...
// checks if the UidListChildren type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UidListChildren{}
...
func (o UidListChildren) ToMap() (map[string]interface{}, error) {
