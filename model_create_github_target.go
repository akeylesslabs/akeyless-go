...
// checks if the CreateGithubTarget type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateGithubTarget{}
...
type _CreateGithubTarget CreateGithubTarget
...
func (o CreateGithubTarget) ToMap() (map[string]interface{}, error) {
...
func (o *CreateGithubTarget) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateGithubTarget := _CreateGithubTarget{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateGithubTarget)

	if err != nil {
		return err
	}

	*o = CreateGithubTarget(varCreateGithubTarget)
