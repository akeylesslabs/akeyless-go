...
// checks if the AuthMethodCreateOauth2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthMethodCreateOauth2{}

// AuthMethodCreateOauth2 authMethodCreateOauth2 is a command that creates a new auth method that will be able to authenticate using Oauth2.
type AuthMethodCreateOauth2 struct {
...
type _AuthMethodCreateOauth2 AuthMethodCreateOauth2
...
func (o AuthMethodCreateOauth2) MarshalJSON() ([]byte, error) {
...
func (o AuthMethodCreateOauth2) ToMap() (map[string]interface{}, error) {
...
func (o *AuthMethodCreateOauth2) UnmarshalJSON(data []byte) (err error) {
	...
	varAuthMethodCreateOauth2 := _AuthMethodCreateOauth2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAuthMethodCreateOauth2)

	if err != nil {
		return err
	}

	*o = AuthMethodCreateOauth2(varAuthMethodCreateOauth2)

	return err
}

type NullableAuthMethodCreateOauth2 struct {
	value *AuthMethodCreateOauth2
	isSet bool
}

func (v NullableAuthMethodCreateOauth2) Get() *AuthMethodCreateOauth2 {
	return v.value
}

func (v *NullableAuthMethodCreateOauth2) Set(val *AuthMethodCreateOauth2) {
	v.value = val
	v.isSet = true
}

func (v NullableAuthMethodCreateOauth2) IsSet() bool {
	return v.isSet
}

func (v *NullableAuthMethodCreateOauth2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuthMethodCreateOauth2(val *AuthMethodCreateOauth2) *NullableAuthMethodCreateOauth2 {
	return &NullableAuthMethodCreateOauth2{value: val, isSet: true}
}

func (v NullableAuthMethodCreateOauth2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuthMethodCreateOauth2) UnmarshalJSON(src []byte) error {
	v.isSet = true
