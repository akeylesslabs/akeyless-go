...
// checks if the AuthMethodUpdateGcp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthMethodUpdateGcp{}
...
type _AuthMethodUpdateGcp AuthMethodUpdateGcp
...
func (o AuthMethodUpdateGcp) ToMap() (map[string]interface{}, error) {
...
func (o *AuthMethodUpdateGcp) UnmarshalJSON(data []byte) (err error) {
	...
	varAuthMethodUpdateGcp := _AuthMethodUpdateGcp{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAuthMethodUpdateGcp)

	if err != nil {
		return err
	}

	*o = AuthMethodUpdateGcp(varAuthMethodUpdateGcp)
