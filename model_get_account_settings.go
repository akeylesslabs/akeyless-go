...
// checks if the GetAccountSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAccountSettings{}
...
func (o GetAccountSettings) ToMap() (map[string]interface{}, error) {
