...
// DsCreateAws dsCreateAws is a command that creates aws dynamic secret
type DsCreateAws struct {
...
func (o DsCreateAws) MarshalJSON() ([]byte, error) {
...
type NullableDsCreateAws struct {
	value *DsCreateAws
	isSet bool
}

func (v NullableDsCreateAws) Get() *DsCreateAws {
	return v.value
}

func (v *NullableDsCreateAws) Set(val *DsCreateAws) {
	v.value = val
	v.isSet = true
}

func (v NullableDsCreateAws) IsSet() bool {
	return v.isSet
}

func (v *NullableDsCreateAws) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDsCreateAws(val *DsCreateAws) *NullableDsCreateAws {
	return &NullableDsCreateAws{value: val, isSet: true}
}

func (v NullableDsCreateAws) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDsCreateAws) UnmarshalJSON(src []byte) error {
	v.isSet = true
