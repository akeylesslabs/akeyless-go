...
// checks if the GatewayCreateProducerSnowflakeOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GatewayCreateProducerSnowflakeOutput{}
...
func (o GatewayCreateProducerSnowflakeOutput) ToMap() (map[string]interface{}, error) {
