...
// checks if the KmipListClients type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KmipListClients{}

// KmipListClients struct for KmipListClients
type KmipListClients struct {
...
func (o KmipListClients) MarshalJSON() ([]byte, error) {
...
func (o KmipListClients) ToMap() (map[string]interface{}, error) {
...
type NullableKmipListClients struct {
	value *KmipListClients
	isSet bool
}

func (v NullableKmipListClients) Get() *KmipListClients {
	return v.value
}

func (v *NullableKmipListClients) Set(val *KmipListClients) {
	v.value = val
	v.isSet = true
}

func (v NullableKmipListClients) IsSet() bool {
	return v.isSet
}

func (v *NullableKmipListClients) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKmipListClients(val *KmipListClients) *NullableKmipListClients {
	return &NullableKmipListClients{value: val, isSet: true}
}

func (v NullableKmipListClients) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKmipListClients) UnmarshalJSON(src []byte) error {
	v.isSet = true
