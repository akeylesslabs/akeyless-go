...
// checks if the CreateAuthMethodOCIOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAuthMethodOCIOutput{}
...
func (o CreateAuthMethodOCIOutput) ToMap() (map[string]interface{}, error) {
