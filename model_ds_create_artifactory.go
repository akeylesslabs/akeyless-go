...
// DsCreateArtifactory dsCreateArtifactory is a command that creates artifactory dynamic secret
type DsCreateArtifactory struct {
...
func (o DsCreateArtifactory) MarshalJSON() ([]byte, error) {
...
type NullableDsCreateArtifactory struct {
	value *DsCreateArtifactory
	isSet bool
}

func (v NullableDsCreateArtifactory) Get() *DsCreateArtifactory {
	return v.value
}

func (v *NullableDsCreateArtifactory) Set(val *DsCreateArtifactory) {
	v.value = val
	v.isSet = true
}

func (v NullableDsCreateArtifactory) IsSet() bool {
	return v.isSet
}

func (v *NullableDsCreateArtifactory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDsCreateArtifactory(val *DsCreateArtifactory) *NullableDsCreateArtifactory {
	return &NullableDsCreateArtifactory{value: val, isSet: true}
}

func (v NullableDsCreateArtifactory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDsCreateArtifactory) UnmarshalJSON(src []byte) error {
	v.isSet = true
