...
// checks if the AuthMethodUpdateOIDC type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthMethodUpdateOIDC{}
...
type _AuthMethodUpdateOIDC AuthMethodUpdateOIDC
...
func (o AuthMethodUpdateOIDC) ToMap() (map[string]interface{}, error) {
...
func (o *AuthMethodUpdateOIDC) UnmarshalJSON(data []byte) (err error) {
	...
	varAuthMethodUpdateOIDC := _AuthMethodUpdateOIDC{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAuthMethodUpdateOIDC)

	if err != nil {
		return err
	}

	*o = AuthMethodUpdateOIDC(varAuthMethodUpdateOIDC)
