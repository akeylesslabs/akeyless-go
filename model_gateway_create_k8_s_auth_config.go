...
type _GatewayCreateK8SAuthConfig GatewayCreateK8SAuthConfig
...
func (o *GatewayCreateK8SAuthConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varGatewayCreateK8SAuthConfig := _GatewayCreateK8SAuthConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGatewayCreateK8SAuthConfig)

	if err != nil {
		return err
	}

	*o = GatewayCreateK8SAuthConfig(varGatewayCreateK8SAuthConfig)
