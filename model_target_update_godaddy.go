...
// checks if the TargetUpdateGodaddy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TargetUpdateGodaddy{}
...
type _TargetUpdateGodaddy TargetUpdateGodaddy
...
func (o *TargetUpdateGodaddy) UnmarshalJSON(data []byte) (err error) {
	...
	varTargetUpdateGodaddy := _TargetUpdateGodaddy{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTargetUpdateGodaddy)

	if err != nil {
		return err
	}

	*o = TargetUpdateGodaddy(varTargetUpdateGodaddy)
