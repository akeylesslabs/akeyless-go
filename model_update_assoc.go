...
// checks if the UpdateAssoc type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateAssoc{}
...
func (o UpdateAssoc) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateAssoc) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateAssoc := _UpdateAssoc{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateAssoc)

	if err != nil {
		return err
	}

	*o = UpdateAssoc(varUpdateAssoc)
