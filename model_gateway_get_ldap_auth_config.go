...
// checks if the GatewayGetLdapAuthConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GatewayGetLdapAuthConfig{}
...
func (o GatewayGetLdapAuthConfig) ToMap() (map[string]interface{}, error) {
