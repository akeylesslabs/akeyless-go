...
// DsUpdatePing dsUpdatePing is a command that updates Ping dynamic secret
type DsUpdatePing struct {
...
func (o DsUpdatePing) MarshalJSON() ([]byte, error) {
...
type NullableDsUpdatePing struct {
	value *DsUpdatePing
	isSet bool
}

func (v NullableDsUpdatePing) Get() *DsUpdatePing {
	return v.value
}

func (v *NullableDsUpdatePing) Set(val *DsUpdatePing) {
	v.value = val
	v.isSet = true
}

func (v NullableDsUpdatePing) IsSet() bool {
	return v.isSet
}

func (v *NullableDsUpdatePing) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDsUpdatePing(val *DsUpdatePing) *NullableDsUpdatePing {
	return &NullableDsUpdatePing{value: val, isSet: true}
}

func (v NullableDsUpdatePing) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDsUpdatePing) UnmarshalJSON(src []byte) error {
	v.isSet = true
