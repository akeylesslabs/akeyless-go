...
// checks if the CreateZeroSSLTargetOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateZeroSSLTargetOutput{}
...
func (o CreateZeroSSLTargetOutput) ToMap() (map[string]interface{}, error) {
