...
type _GatewayUpdateProducerLdap GatewayUpdateProducerLdap
...
func (o *GatewayUpdateProducerLdap) UnmarshalJSON(data []byte) (err error) {
	...
	varGatewayUpdateProducerLdap := _GatewayUpdateProducerLdap{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGatewayUpdateProducerLdap)

	if err != nil {
		return err
	}

	*o = GatewayUpdateProducerLdap(varGatewayUpdateProducerLdap)
