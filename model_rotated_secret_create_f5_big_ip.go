...
// checks if the RotatedSecretCreateF5BigIp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RotatedSecretCreateF5BigIp{}

// RotatedSecretCreateF5BigIp struct for RotatedSecretCreateF5BigIp
type RotatedSecretCreateF5BigIp struct {
...
type _RotatedSecretCreateF5BigIp RotatedSecretCreateF5BigIp
...
func NewRotatedSecretCreateF5BigIp(name string, rotatorType string, targetName string) *RotatedSecretCreateF5BigIp {
	this := RotatedSecretCreateF5BigIp{}
...
func (o RotatedSecretCreateF5BigIp) MarshalJSON() ([]byte, error) {
...
func (o RotatedSecretCreateF5BigIp) ToMap() (map[string]interface{}, error) {
...
func (o *RotatedSecretCreateF5BigIp) UnmarshalJSON(data []byte) (err error) {
	...
	varRotatedSecretCreateF5BigIp := _RotatedSecretCreateF5BigIp{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRotatedSecretCreateF5BigIp)

	if err != nil {
		return err
	}

	*o = RotatedSecretCreateF5BigIp(varRotatedSecretCreateF5BigIp)

	return err
}

type NullableRotatedSecretCreateF5BigIp struct {
	value *RotatedSecretCreateF5BigIp
	isSet bool
}

func (v NullableRotatedSecretCreateF5BigIp) Get() *RotatedSecretCreateF5BigIp {
	return v.value
}

func (v *NullableRotatedSecretCreateF5BigIp) Set(val *RotatedSecretCreateF5BigIp) {
	v.value = val
	v.isSet = true
}

func (v NullableRotatedSecretCreateF5BigIp) IsSet() bool {
	return v.isSet
}

func (v *NullableRotatedSecretCreateF5BigIp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRotatedSecretCreateF5BigIp(val *RotatedSecretCreateF5BigIp) *NullableRotatedSecretCreateF5BigIp {
	return &NullableRotatedSecretCreateF5BigIp{value: val, isSet: true}
}

func (v NullableRotatedSecretCreateF5BigIp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRotatedSecretCreateF5BigIp) UnmarshalJSON(src []byte) error {
	v.isSet = true
