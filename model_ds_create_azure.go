...
// DsCreateAzure dsCreateAzure is a command that creates azure dynamic secret
type DsCreateAzure struct {
	// Azure App Object Id
...
func (o DsCreateAzure) MarshalJSON() ([]byte, error) {
...
type NullableDsCreateAzure struct {
	value *DsCreateAzure
	isSet bool
}

func (v NullableDsCreateAzure) Get() *DsCreateAzure {
	return v.value
}

func (v *NullableDsCreateAzure) Set(val *DsCreateAzure) {
	v.value = val
	v.isSet = true
}

func (v NullableDsCreateAzure) IsSet() bool {
	return v.isSet
}

func (v *NullableDsCreateAzure) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDsCreateAzure(val *DsCreateAzure) *NullableDsCreateAzure {
	return &NullableDsCreateAzure{value: val, isSet: true}
}

func (v NullableDsCreateAzure) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDsCreateAzure) UnmarshalJSON(src []byte) error {
	v.isSet = true
