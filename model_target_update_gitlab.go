...
// checks if the TargetUpdateGitlab type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TargetUpdateGitlab{}
...
type _TargetUpdateGitlab TargetUpdateGitlab
...
func (o TargetUpdateGitlab) ToMap() (map[string]interface{}, error) {
...
func (o *TargetUpdateGitlab) UnmarshalJSON(data []byte) (err error) {
	...
	varTargetUpdateGitlab := _TargetUpdateGitlab{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTargetUpdateGitlab)

	if err != nil {
		return err
	}

	*o = TargetUpdateGitlab(varTargetUpdateGitlab)
