...
// checks if the UpdateGKETarget type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateGKETarget{}
...
type _UpdateGKETarget UpdateGKETarget
...
func (o UpdateGKETarget) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateGKETarget) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateGKETarget := _UpdateGKETarget{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateGKETarget)

	if err != nil {
		return err
	}

	*o = UpdateGKETarget(varUpdateGKETarget)
