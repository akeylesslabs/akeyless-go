...
// checks if the DynamicSecretUpdatePostgreSql type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DynamicSecretUpdatePostgreSql{}
...
type _DynamicSecretUpdatePostgreSql DynamicSecretUpdatePostgreSql
...
func (o DynamicSecretUpdatePostgreSql) ToMap() (map[string]interface{}, error) {
...
func (o *DynamicSecretUpdatePostgreSql) UnmarshalJSON(data []byte) (err error) {
	...
	varDynamicSecretUpdatePostgreSql := _DynamicSecretUpdatePostgreSql{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDynamicSecretUpdatePostgreSql)

	if err != nil {
		return err
	}

	*o = DynamicSecretUpdatePostgreSql(varDynamicSecretUpdatePostgreSql)
