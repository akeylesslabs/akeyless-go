...
type _CreateEKSTarget CreateEKSTarget
...
func (o *CreateEKSTarget) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateEKSTarget := _CreateEKSTarget{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateEKSTarget)

	if err != nil {
		return err
	}

	*o = CreateEKSTarget(varCreateEKSTarget)
