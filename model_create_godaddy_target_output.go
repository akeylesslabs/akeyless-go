...
// checks if the CreateGodaddyTargetOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateGodaddyTargetOutput{}
...
func (o CreateGodaddyTargetOutput) ToMap() (map[string]interface{}, error) {
