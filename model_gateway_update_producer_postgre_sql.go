...
type _GatewayUpdateProducerPostgreSQL GatewayUpdateProducerPostgreSQL
...
func (o *GatewayUpdateProducerPostgreSQL) UnmarshalJSON(data []byte) (err error) {
	...
	varGatewayUpdateProducerPostgreSQL := _GatewayUpdateProducerPostgreSQL{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGatewayUpdateProducerPostgreSQL)

	if err != nil {
		return err
	}

	*o = GatewayUpdateProducerPostgreSQL(varGatewayUpdateProducerPostgreSQL)
