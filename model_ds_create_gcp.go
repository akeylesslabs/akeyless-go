...
// DsCreateGcp dsCreateGcp is a command that creates a GCP dynamic secret
type DsCreateGcp struct {
...
func (o DsCreateGcp) MarshalJSON() ([]byte, error) {
...
type NullableDsCreateGcp struct {
	value *DsCreateGcp
	isSet bool
}

func (v NullableDsCreateGcp) Get() *DsCreateGcp {
	return v.value
}

func (v *NullableDsCreateGcp) Set(val *DsCreateGcp) {
	v.value = val
	v.isSet = true
}

func (v NullableDsCreateGcp) IsSet() bool {
	return v.isSet
}

func (v *NullableDsCreateGcp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDsCreateGcp(val *DsCreateGcp) *NullableDsCreateGcp {
	return &NullableDsCreateGcp{value: val, isSet: true}
}

func (v NullableDsCreateGcp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDsCreateGcp) UnmarshalJSON(src []byte) error {
	v.isSet = true
