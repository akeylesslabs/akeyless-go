...
*V2Api* | [**CreateManagedKey**](docs/V2Api.md#createmanagedkey) | **Post** /create-managed-key | 
...
*V2Api* | [**GatewayUpdateItem**](docs/V2Api.md#gatewayupdateitem) | **Post** /update-managed-key | 
...
## Documentation For Models
 ...
 - [CreateManagedKey](docs/CreateManagedKey.md)
 - [CreateManagedKeyOutput](docs/CreateManagedKeyOutput.md)
 ...
 - [CreateTargetOutput](docs/CreateTargetOutput.md)
 ...
 - [ManagedKeyDetailsInfo](docs/ManagedKeyDetailsInfo.md)
 - [ManagedKeyStatusInfo](docs/ManagedKeyStatusInfo.md)
 - [ManagedKeyTargetInfo](docs/ManagedKeyTargetInfo.md)
 ...
 - [UpdateManagedKey](docs/UpdateManagedKey.md)
 ...
 - [UpdateRotatedSecretSC](docs/UpdateRotatedSecretSC.md)
 - [UpdateRotatedSecretSCOutput](docs/UpdateRotatedSecretSCOutput.md)
