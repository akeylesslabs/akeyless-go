...
// DsUpdateCertificateAutomation dsUpdateCertificateAutomation is a command that updates a Certificate Automation dynamic secret to dynamically update certificates generated by Venafi or have Akeyless generated certificates using PKI be monitored by Venafi
type DsUpdateCertificateAutomation struct {
...
func NewDsUpdateCertificateAutomation(name string, ) *DsUpdateCertificateAutomation {
	this := DsUpdateCertificateAutomation{}
...
func (o DsUpdateCertificateAutomation) MarshalJSON() ([]byte, error) {
...
type NullableDsUpdateCertificateAutomation struct {
	value *DsUpdateCertificateAutomation
	isSet bool
}

func (v NullableDsUpdateCertificateAutomation) Get() *DsUpdateCertificateAutomation {
	return v.value
}

func (v *NullableDsUpdateCertificateAutomation) Set(val *DsUpdateCertificateAutomation) {
	v.value = val
	v.isSet = true
}

func (v NullableDsUpdateCertificateAutomation) IsSet() bool {
	return v.isSet
}

func (v *NullableDsUpdateCertificateAutomation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDsUpdateCertificateAutomation(val *DsUpdateCertificateAutomation) *NullableDsUpdateCertificateAutomation {
	return &NullableDsUpdateCertificateAutomation{value: val, isSet: true}
}

func (v NullableDsUpdateCertificateAutomation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDsUpdateCertificateAutomation) UnmarshalJSON(src []byte) error {
	v.isSet = true
