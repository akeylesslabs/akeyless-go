...
// DsUpdateK8s dsUpdateK8s is a command that updates k8s dynamic secret
type DsUpdateK8s struct {
...
func (o DsUpdateK8s) MarshalJSON() ([]byte, error) {
...
type NullableDsUpdateK8s struct {
	value *DsUpdateK8s
	isSet bool
}

func (v NullableDsUpdateK8s) Get() *DsUpdateK8s {
	return v.value
}

func (v *NullableDsUpdateK8s) Set(val *DsUpdateK8s) {
	v.value = val
	v.isSet = true
}

func (v NullableDsUpdateK8s) IsSet() bool {
	return v.isSet
}

func (v *NullableDsUpdateK8s) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDsUpdateK8s(val *DsUpdateK8s) *NullableDsUpdateK8s {
	return &NullableDsUpdateK8s{value: val, isSet: true}
}

func (v NullableDsUpdateK8s) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDsUpdateK8s) UnmarshalJSON(src []byte) error {
	v.isSet = true
