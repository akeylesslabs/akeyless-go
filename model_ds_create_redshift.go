...
// DsCreateRedshift dsCreateRedshift is a command that creates redshift dynamic secret
type DsCreateRedshift struct {
...
func (o DsCreateRedshift) MarshalJSON() ([]byte, error) {
...
type NullableDsCreateRedshift struct {
	value *DsCreateRedshift
	isSet bool
}

func (v NullableDsCreateRedshift) Get() *DsCreateRedshift {
	return v.value
}

func (v *NullableDsCreateRedshift) Set(val *DsCreateRedshift) {
	v.value = val
	v.isSet = true
}

func (v NullableDsCreateRedshift) IsSet() bool {
	return v.isSet
}

func (v *NullableDsCreateRedshift) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDsCreateRedshift(val *DsCreateRedshift) *NullableDsCreateRedshift {
	return &NullableDsCreateRedshift{value: val, isSet: true}
}

func (v NullableDsCreateRedshift) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDsCreateRedshift) UnmarshalJSON(src []byte) error {
	v.isSet = true
