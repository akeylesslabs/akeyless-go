...
// checks if the UpdateNativeK8STargetOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateNativeK8STargetOutput{}
...
func (o UpdateNativeK8STargetOutput) ToMap() (map[string]interface{}, error) {
