...
// checks if the CreateAuthMethodAzureAD type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAuthMethodAzureAD{}
...
type _CreateAuthMethodAzureAD CreateAuthMethodAzureAD
...
func (o CreateAuthMethodAzureAD) ToMap() (map[string]interface{}, error) {
...
func (o *CreateAuthMethodAzureAD) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateAuthMethodAzureAD := _CreateAuthMethodAzureAD{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateAuthMethodAzureAD)

	if err != nil {
		return err
	}

	*o = CreateAuthMethodAzureAD(varCreateAuthMethodAzureAD)
