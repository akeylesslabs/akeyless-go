...
// checks if the GatewayCreateProducerGke type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GatewayCreateProducerGke{}
...
type _GatewayCreateProducerGke GatewayCreateProducerGke
...
func (o GatewayCreateProducerGke) ToMap() (map[string]interface{}, error) {
...
func (o *GatewayCreateProducerGke) UnmarshalJSON(data []byte) (err error) {
	...
	varGatewayCreateProducerGke := _GatewayCreateProducerGke{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGatewayCreateProducerGke)

	if err != nil {
		return err
	}

	*o = GatewayCreateProducerGke(varGatewayCreateProducerGke)
